...
public class DateUtil {
	...
	/**
	 * 把字符串表示的时间加上n天，再转成字符串返回
	 * @param date 要处理的日期
	 * @param n 要加的天数
	 * @param form 自定义日期格式，若为空，则使用“yyyy-MM-dd”
	 * @return
	 */
	public static String addDays(String date,int n,String form){
	...
	public static void main(String[] args) {
		System.out.println(getDaySub(StringToDate("2018-10-01"),StringToDate("2018-09-29")));
	}
}