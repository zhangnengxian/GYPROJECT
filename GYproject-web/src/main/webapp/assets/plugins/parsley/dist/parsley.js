  ...
  */
    ...
    validators: {
      ...
      type: function (type) {
        ...
        switch (type) {
          ...
          break;
          case 'mobilephone':
             assert = new Validator.Assert().Regexp('(\\+?86)?(13[012356789]\\d{8}|15[012356789]\\d{8}|18[02356789]\\d{8}|147\\d{8}|1349\\d{7})$', 'i');
          break;
          default:
  ...
  ParsleyUI.prototype = {
    ...
    addError: function (fieldInstance, name, message, assert, doNotUpdateClass) {
      ...
      fieldInstance._ui.$errorClassHandler.attr('data-original-title',"");
