...
var handleJqueryFileUpload = function(formObj) {
	...
	if($("#changeType").val()==2){
		//FileTypes =/(\.|\/)(xlsx|xls|docx|png|jpg|jpeg|pdf|zip|rar|7z|doc|txt|dwg|gpb|gpb8|gpb9|apk)$/i;
		FileTypes =/(\.|\/)(xlsx|xls|docx|png|jpg|jpeg|pdf|zip|rar|7z|doc|txt|dwg|gpb[0-9]*$|gbg[0-9]*$|apk)$/i;
	}
