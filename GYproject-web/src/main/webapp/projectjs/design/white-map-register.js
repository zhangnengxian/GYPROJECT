    ...
    if ($('#whiteMapRegisterTable').length !== 0) {
    	offdrawing= $('#whiteMapRegisterTable').on( 'init.dt',function(){
    		...
    		$(this).bindDTSelected(trSelectedBack,true);
   			//加载页面
   			$("#official_drawing_panel_box").cgetContent("whiteMapRegister/viewPage");
   			//隐藏遮罩
...
//   				offdrawing.ajax.reload();	
            ...
            serverSide:true,
            ajax: {
                url: 'whiteMapRegister/queryProject',
                type:'post',
                data: function(d){
...
var trSelectedBack = function(v, i, index, t, json){
	...
	t.cgetDetail('whiteMapRegisterForm','whiteMapRegister/viewProject','',datailBack);
}
/**
 * 初始化工程列表
 */
