    ...
    if ($('#recordListTable').length !== 0) {
    	recordListTable= $('#recordListTable').on( 'init.dt',function(){
            ...
            columns: [
				...
				{"data":"filler"},
				{"data":"number",className:"text-right"},
				{"data":"nominalPressure",className:"text-right"},
				{"data":"strengthMedium"},
				{"data":"strengthPressure",className:"text-right"},
				{"data":"strengthTime",className:"text-right"},
				{"data":"tightnessMedium"},
				{"data":"tightnessPressure",className:"text-right"},
				{"data":"tightnessTime",className:"text-right"},
				{"data":"visualInspcet"}
			],
			columnDefs: [{
				"targets":0,
...
$(".deleteBtn2").on("click",function(){
	var len=$('#recordListTable').find('tr.selected').length;
	 if(len>0){
		 var rows =trSData.recordListTable.json;
		 if(rows.vtId){
			 delRowData = delRowData + rows.vtId+',';
		 }
