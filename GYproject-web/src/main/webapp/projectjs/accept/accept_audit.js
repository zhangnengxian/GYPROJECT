    	...
    	$('#gasAuditTable').on( 'init.dt',function(){
			...
			columnDefs: [{
				...
				"render": function ( data, type, row, meta ) {
					if(type==="display"){				
						var html = getAuditLevelHtml(data,row.level,row.projId,"110107");
						return html;
					}else{
						return data;
					}
...
var auditBtnMonitor = function(){
	...
	$(document).off("click", ".level").on("click", ".level", function(){
		...
		$("#ajax-content").cgetContent("acceptAudit/auditPage",data);
	});
