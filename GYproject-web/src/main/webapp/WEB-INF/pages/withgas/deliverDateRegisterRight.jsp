...
<div class="infodetails">
    ...
    <div class="clearboth form-box">
    	...
    	<form class="form-horizontal" id="deliverDateRegisterForm" action="deliverDateRegister/saveGasProject">
			...
			<div class="form-group col-md-12 ">
		    	<!-- 新加字段 -->
		        <label class="control-label" for="gasRemark">开通备注</label>
				<div>
		     ...
		     <div class="form-group col-md-6 col-sm-12  ">
		    	...
		    	<div>
		    		<input type="text" class="form-control input-sm field-not-editable timestamp" id="planGasDate" name="planGasDate"  />
		        </div>
		    </div>
		    <div class="form-group col-md-6 col-sm-12  ">
		        <label class="control-label" for="">交付时间</label>
		    	<div>
		    ...
		    <div class="form-group col-md-12 ">
		    	<!-- 新加字段 -->
		        <label class="control-label" for="reason">交付备注</label>
				<div>
					<textarea class="form-control input-sm field-editable" id="reason" name="reason" data-parsley-maxlength="200" ></textarea>
				</div>
		    </div>
...
<script>
    ...
    //参数传false时，表单不可编辑
    $("#deliverDateRegisterForm").toggleEditState(false).styleFit();
    $(".editbtn").addClass("hidden");
    trSData.t && trSData.t.cgetDetail('deliverDateRegisterForm','','',scaleDetailRefresh(trSData.json));
    ...
    $(".saveBtn").off("click").on("click",function(){
    	$('#deliverDateRegisterForm').cformSave('deliverDateRegisterTable',saveCallBack);
    });
