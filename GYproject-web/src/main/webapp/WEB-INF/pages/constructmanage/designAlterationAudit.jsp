        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">变更记录审核列表</h4>
                </div>
...
<script>
    ...
    App.setPageTitle('碰口记录审核 - 工程管理系统');
    
  //是否已选工程项目
    if(!getProjectInfo()){
    	loadProjectList();
    }else{
    	$.getScript('projectjs/constructmanage/design-alteration-audit.js?v='+Math.random()).done(function () {
