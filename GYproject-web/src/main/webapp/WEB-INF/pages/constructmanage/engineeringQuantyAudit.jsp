        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">签证量审核列表</h4>
                </div>
...
<script>
   ...
   //是否已选工程项目
    if(!getProjectInfo()){engineeringQuantyAudit
    	loadProjectList();
    }else{ 
    	$("#projId").val(getProjectInfo().projId);
    	$("#waitHandleProjNo").val(getProjectInfo().projNo);
    	$.getScript('projectjs/constructmanage/engineering-quanty-audit.js?v='+Math.random()).done(function () {
