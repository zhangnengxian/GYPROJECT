            ...
            <div class="panel panel-inverse tabs-mixin ">
                <div class="panel-heading">
                	...
                	<ul class="nav nav-tabs ">
						<li class="active"><a href="#inspection_list" data-toggle="tab"id ="securityCheckList">质量检查</a></li>
                ...
                <div class="panel-body " id="box">
                	...
                	<div class="tab-content">
	                	...
	                	<div class="tab-pane fade active in btn-top active" id="inspection_list" >
	                		<table class="table table-hover table-striped table-bordered nowrap" id="qualityInspectionTable" width="100%">
	                			<thead>
	                			<tr>
	                				<th>id</th>
		                			<th>日期</th>
	                	...
	                	<div class="tab-pane fade in btn-top" id="inspection_record">
	                		<div class=" f-r p-b-10 editbtn">
	    					 	<a href="javascript:;" class="btn btn-default btn-confirm btn-sm m-l-5 checkRole saveCustomer" onclick="showReport()" >保存</a>
						 	 ...
						 	 <div class="clearboth form-box p-b-10">
						 	 	<form class="form-horizontal" id="qualityInspectionForm" action="">
						 	 	...
						 	 	<input type="hidden" value="" id="projNo" name="projNo"/>
							 		<div class="form-group col-xs-12">
			   						...
			   						<div class="form-group col-md-12 col-sm-12" style="clear:left">
								    ...
								    <div class="form-group col-md-6 col-sm-12 ">
			   						...
			   						<div class="form-group col-md-6 col-sm-12">
								        ...
								        <div>
								            <input type="text" class="form-control input-sm field-not-editable" value="" id="projScaleDes" name="projScaleDes" />
								        </div>
								    </div>
								   <!--  <div class="form-group col-md-6 col-sm-12">
									...
									<div class="form-group col-md-6 col-sm-12">
										...
										<div>
											<input type="text" class="form-control input-sm field-not-editable" id="checkDepartment" name="checkDepartment" value="${deptName}"/>
										</div>
									</div>
			   						<div class="form-group col-md-6 col-sm-12">
								        <label class="control-label">检查日期</label>
								        <div>
								            <input type="text" class="form-control input-sm datepicker-default allText technician" value="" id="checkDate" name="checkDate" data-parsley-required="true"/>
								        </div>
								    </div>
			   						...
			   						<div class="form-group col-md-6 col-sm-12 allSign technician">
										...
										<div>
											...
											<input type="hidden" id="inspector_postType" name="inspector_postType" value="${TECHNICIAN }" >
						    ...
						    <div class="toolbtn pull-right editbtn clearboth p-b-10 addBtnClass">
						 	...
						 	<table id="qualityInspectionAuditTable" class="table table-striped table-bordered nowrap" width="100%">
	                           <thead>
	                               <tr>
	                               	   <th>id</th>
	                               	   <th>saId</th>
...
<script>
    ...
    App.setPageTitle('质量保证 - 工程施工管理系统 ');
    ...
    $("#areaId").val(getProjectInfo().areaDes);
  ...
  //右屏导入帆软报表
	 var showReport = function(data){
		  ...
		  //console.log(trSData);
		  if(trSData.qualityInspectionTable){
			  if(trSData.qualityInspectionTable.json && isAddRow != 1 ){
				  ilId = trSData.qualityInspectionTable.json.ilId;
				  checkDate = encodeURIComponent(cjkEncode(trSData.qualityInspectionTable.json.checkDate)),			//检查日期
				  fieldPrincipal = encodeURIComponent(cjkEncode(trSData.qualityInspectionTable.json.fieldPrincipal));	//现场负责人
			  }
		  }
		    var remark = encodeURIComponent(cjkEncode($('#remark').val()));//检查情况及其他问题
			...
			checkDepartment=encodeURIComponent(cjkEncode($("#checkDepartment").val())),					//检查单位
	 		src= cptPath + "/ReportServer?reportlet=constructmanage/securitInspection1.cpt&imgUrl="+imgUrl+"&ilId="+ilId;
   			var inspector = "";
   			var examinee = "";
   			if(data){
   			...
   			src = src+"&examinee="+examinee+"&inspector="+inspector;
   			src = src +"&remark="+remark;
   			$("#mainFrm").attr("src",src); 
}
	showReport();
	$.getScript('projectjs/constructmanage/quality_inspection_record.js?v='+Math.random()).done(function () {
