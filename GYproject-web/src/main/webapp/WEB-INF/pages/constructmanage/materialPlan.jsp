        ...
        <div class="col-sm-6 col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">材料领用反馈列表</h4>
                </div>
        ...
        <div class="col-sm-6 col-xs-12" >
            <div class="panel panel-inverse" id="content">
			    <div class="panel-heading">
			        ...
			        <h4 class="panel-title">材料领用信息区</h4>
			    </div>
...
<script>
    ...
    App.setPageTitle('材料计划 - 工程施工管理系统 ');

    $.getScript('projectjs/constructmanage/material-plan.js').done(function () {
    	materialPlan.init();
    });
    if(!getProjectInfo()){
    	loadProjectList();
    	...
    	$('#projId1').val(projJson.projId);					   //工程ID
    }
