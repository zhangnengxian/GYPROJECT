        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">材料使用</h4>
                </div>
                <div class="panel-body">
			        <div class="mask-html text-center"><div><i class="fa fa-3x fa-spinner"></i><br><p class="text-ellipsis">加载中</p></div></div>
			        <form action="" id="materialUseForm">
				        <table id="materialUseTable" class="table table-striped table-bordered nowrap " width="100%">
		            		<thead>
		                		<tr>
					                ...
					                <th width="80">本次使用量</th>
					                <th width="80">实际安装总量</th>
					                <th width="80">本次安装量</th>
		                		</tr>
			               	</thead>
		    	  	  	</table>
	    	  	  	</form>
...
<script>
    ...
    App.setPageTitle('材料使用 - 工程施工管理系统 ');
  	//是否已选工程项目
    if(!getProjectInfo()){
    	loadProjectList();
    }
                        ...
                        $.getScript('assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js').done(function () {
	                        $.getScript('assets/plugins/jquery-deserialize-master/src/jquery.deserialize.min.js').done(function () {
	                         	$.getScript('assets/plugins/parsley/dist/parsley.js').done(function () {
	                          		$.getScript('projectjs/constructmanage/material-use.js?v=1001').done(function () {
	                          			materialUse.init();
	                              	});
	                         	});
	                        });
