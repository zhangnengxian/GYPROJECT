...
<link href="assets/plugins/powerange/powerange.min.css" rel="stylesheet"/>
        ...
        <div class="form-group col-md-6 col-xs-12 allSign productionStatisticians">
        ...
        <div class="hidden rectifyNoticeBack">
            <div class="form-group col-md-12 col-sm-12">
                ...
                <div>
                    <textarea class="form-control input-sm  field-editable addClear" row="4" id="rnExplain" name="rnExplain" data-parsley-required="true" data-parsley-maxlength="200"></textarea>
                </div>
            </div>
            <div class="form-group col-md-12 col-sm-12">
                <label class="control-label" for="selfCheckResult">自检结果</label>
                <div>
                    <textarea class="form-control input-sm  field-editable addClear" row="2" id="selfCheckResult" name="selfCheckResult" data-parsley-required="true" data-parsley-maxlength="200"></textarea>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 allSign cuPm">
            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <div>
                    <input type="text" class="form-control input-sm datepicker-default field-not-editable addClear" value="" id="selfCheckDate" name="selfCheckDate" data-parsley-required="true"/>
                </div>
            </div>
            <div class="form-group col-md-12 col-sm-12">
                <label class="control-label" for="reinspectionResult">复验结果</label>
                <div>
                    <textarea class="form-control input-sm  field-editable addClear" row="2" id="reinspectionResult" name="reinspectionResult" data-parsley-required="true" data-parsley-maxlength="200"></textarea>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 allSign suJgj">
            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <div>
                    <input type="text" class="form-control input-sm datepicker-default field-not-editable addClear"  value="" id="reinspectionDate" name="reinspectionDate" data-parsley-required="true"/>
                </div>
            </div>
        </div>
...
<script>
    $.getScript('assets/plugins/jSignature/jSignature.min.js').done(function () {
        var signatures = $("#signBtn_1,#signBtn_2,#signBtn_3,#signBtn_4,#signBtn_5,#signBtn_6,#signBtn_7,#signBtn_8,#signBtn_9,#signBtn_10,#signBtn_11,#signBtn_12").handleSignature();
    });
