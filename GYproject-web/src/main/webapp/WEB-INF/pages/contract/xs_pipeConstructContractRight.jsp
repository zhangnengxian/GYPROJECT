    ...
    <div class="clearboth form-box">
    	...
    	<form class="form-horizontal" id="contractDetailform"  data-parsley-validate="true" action="">
			...
			<div class="form-group col-md-6">
				...
				<div>
					<input type="text" class=" form-control input-sm field-editable datepicker-default" id="plannedStartDate"  name="plannedStartDate">
				</div>
			</div>
			<div class="form-group col-md-6">
				<label class="control-label">计划竣工日期</label>
				<div>
					<input type="text" class=" form-control input-sm field-editable datepicker-default" id="plannedEndDate"  name="plannedEndDate" >
				</div>
			</div>
