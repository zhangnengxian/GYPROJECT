    ...
    <div class="clearboth form-box">
    	<form class="form-horizontal" id="contractDetailform"  data-parsley-validate="true" action="">
		    ...
		    <div class="form-group col-md-6 resident">
		        ...
		        <div>
		           <input type="text" class=" form-control input-sm field-editable text-right" id="household"  name="household" data-parsley-type="number" data-parsley-maxlength="10" value="${contract.household}" >
		        </div>
		    </div>
		    <div class="form-group col-md-6 resident">
