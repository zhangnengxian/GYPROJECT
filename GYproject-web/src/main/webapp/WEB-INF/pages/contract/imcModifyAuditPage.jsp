			    ...
			    <div class="panel-body" id="contract_audit_panel_box">
			    	...
			    	<div class="clearboth form-box auditFormDiv">
			    		<form class="form-horizontal" id="contractAuditRightForm" action="">
                    		...
                    		<input type="hidden"  class="imcId" name = "imcId" value = "${ imcId}"/>
                    		<input type="hidden" id="businessOrderId" name = "businessOrderId" value = "${ imcId}"/>
...
<script>
    ...
    App.setPageTitle('智能表合同修改审核 - 工程管理系统');
    ...
    $.getScript('projectjs/contract/imc-modify-audit-page.js').done(function () {
        auditHistory.init();
	});
    
    //放弃
    $(".auditCancelBtn").off("click").on("click",function(){
		$("#ajax-content").cgetContent("imcModifyAudit/main");
	});
