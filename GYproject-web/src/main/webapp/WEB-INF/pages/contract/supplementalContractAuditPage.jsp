...
<script>
    ...
    $.getScript('projectjs/contract/supplemental-contract-audit-page.js?v='+Math.random()).done(function () {
        auditHistory.init();
	});
     
    //放弃
    $(".auditCancelBtn").off("click").on("click",function(){
		$("#ajax-content").cgetContent("supplementalContractAudit/main");
	});
    ...
    $(".auditSaveBtn").off("click").on("click",function(){
    	...
    	if(val==null){
        	...
        	if($("#contractAuditRightForm").parsley().isValid()){
            	...
            	$.ajax({
                    type: 'POST',
                    url: 'supplementalContractAudit/auditSave',
