...
<div class="infodetails">
    ...
    <div class="clearboth form-box">
		...
		<input type="hidden" id="tempHouseAmount" value="${houseAmount}"/>
    	<form class="form-horizontal" id="contractDetailform"  data-parsley-validate="true" action="">
		    ...
		    <div class="form-group col-md-6 clearboth resident">
		        ...
		        <div>
		            <input type="text" class="form-control input-sm field-editable"  id="houseNum" name="houseNum" data-parsley-maxlength="6" value="" data-parsley-required="true"/>
		        </div>
		    </div>
		     <div class="form-group col-md-6 resident">
		        <label class="control-label" for="houseAmount">每户金额</label>
		        <div>
					<input type="text" class=" form-control input-sm field-editable fixed-number text-right" id="houseAmount"  name="houseAmount" data-parsley-maxlength="13" value="2230" data-parsley-required="true"/>
		    ...
		    <div class="form-group col-md-6 resident clearboth">
...
<script>
    ...
    var viewDetailUrl ='agreementModify/querySupplementalContractDetail' ;
    if($("#differenceId").val() == 'sign'){
    	viewDetailUrl ='supplementalContract/viewsSupplementalContract'
    }
    //查右侧工程详述
    trSData.t&&trSData.t.cgetDetail('contractDetailform',viewDetailUrl,'',getDetailBack);
        	...
        	$.ajax({
                ...
                success: function (data) {
                	...
                	if(data === "false"){
                		...
                		$("#contractDetailform input,#contractDetailform textarea").val('');
                		$(".editbtn").addClass("hidden");
 ...
 var saveDone = function(){
	 $(".editbtn").addClass("hidden");
	 /* 选定的行查询信息到详述区*/
	 trSData.t&&trSData.t.cgetDetail('contractDetailform','supplementalContract/viewsSupplementalContract','',getDetailBack); 
 }  
    ...
    $(".cancelBtn").on("click",function(){
    	 ...
    	 trSData.t.cgetDetail('contractDetailform','constructContract/viewContract',''); 
    ...
    $(".pushBtn").on("click",function(){
        ...
        if($('#differenceId').val()=="sign"){//协议签订页面推送
            content="是否确认完成补充协议的签订？";
		} else if($('#differenceId').val()=="modify"){//协议修改页面推送
            content="是否确认完成补充协议修改推送？";
		}
    ...
    $("#houseNum,#houseAmount").on("change",function(){
    	if($("#resident").val()==$("#scType").val()){
