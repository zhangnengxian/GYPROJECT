    ...
    <div class="clearboth form-box">
    	...
    	<form class="form-horizontal" id="contractDetailform"  data-parsley-validate="true" action="">
		    ...
		    <div class="form-group col-md-12 not-resident">
	            <label class="control-label" for="contractContent">乙方出具</label>
	            <div>
		    ...
		    <div class="form-group col-md-12">
	            <label class="control-label" for="conScope">施工范围</label>
	            <div>
	                <textarea class="form-control field-editable" name ="conScope" id="conScope" rows="2" data-parsley-maxlength="200" data-parsley-required="true"></textarea>
	            </div>
            </div>
            <div class="form-group col-md-6">
			...
			<!-- <div class="form-group col-md-12 REMARK hidden">
	            <label class="control-label" for="contractMethodOther">其他承包方式</label>
	            <div>
	                <input type="text" class="form-control field-editable" name ="contractMethodOther" id="contractMethodOther" rows="2" data-parsley-maxlength="200" data-parsley-required="true"/>
             ...
             <div class="form-group col-md-6">
		        ...
		        <div>
		        	<input type="text" class=" form-control input-sm field-not-editable" id="timeLimit"  name="timeLimit" data-parsley-maxlength="10" data-parsley-required="true" value="" >
            ...
            <div class="form-group col-md-6">
		        ...
		        <div>
		           <input type="text" class=" form-control input-sm field-editable datepicker-default" id="plannedStartDate"  name="plannedStartDate" data-parsley-maxlength="100" value="" data-parsley-required="true">
		        </div>
		    </div>
		     <div class="form-group col-md-6">
		        <label class="control-label" for="plannedEndDate">计划竣工日期</label>
		        <div>
		           <input type="text" class=" form-control input-sm field-editable datepicker-default" id="plannedEndDate"  name="plannedEndDate" data-parsley-maxlength="100" value="" data-parsley-required="true">
		        </div>
		    </div>
...
function dataBack(data){
	...
	$.ajax({
		...
		success: function(data){
			$("#payType").empty();
//				$("#payType").append('<option value="" data-mode="${enums.payTypeMode }"></option>');
...
// 	defaultValue();
	...
	$("#signDate").removeClass("field-not-editable");
	$("#signDate").addClass("field-editable");
...
//     }
	 ...
	 //付款方式1，2，3
	   ...
	   if(payTypeMode=='2'){  //分两期付款
			...
			if(paymentRatio1>0){
				...
				$("#paymentRatio2").val(new Number(100.00-paymentRatio1).toFixed(2));    //计算第二次付款的比列
  ...
  //日期改变计算工期
  $("#plannedStartDate,#plannedEndDate").on("change",function(){
	  var days = ((timestamp($("#plannedEndDate").val())-timestamp($("#plannedStartDate").val()))/(60*60*24)/1000);
	  if(days >= 0){
		  $("#timeLimit").val(days);
	  }else if(($("#plannedStartDate").val()!='') && ($("#plannedEndDate").val()!='' )){
		  $("body").cgetPopup({
           	title: "提示信息",
           	content: "起止日期不能大于终止日期!",
           	accept: popClose,
           	chide: true,
           	icon: "fa-warning",
           	newpop: 'new'
           });  
		  $("#plannedStartDate,#plannedEndDate").val('');  //清空日期
		  $("#timeLimit").val(''); //清空工期
	  }
