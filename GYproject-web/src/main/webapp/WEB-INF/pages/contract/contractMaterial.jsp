		...
		<div class="col-sm-6 col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">安装合同列表</h4>
                </div>
...
<script>
    ...
    App.setPageTitle('施工合同 - 工程项目管理系统 ');
    
    $.getScript('projectjs/contract/contract-material.js?v='+Math.random()).done(function () {
