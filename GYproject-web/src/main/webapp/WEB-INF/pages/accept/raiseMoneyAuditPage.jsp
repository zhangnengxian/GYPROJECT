       ...
       <div class="col-sm-6 col-xs-12">
       		<div class="panel panel-inverse tabs-mixin">
				<div class="panel-heading">
	                ...
	                <h4 class="panel-title">提资审核信息</h4>
				</div>
            	<div class="panel-body">
	           		 <!-- 提资详述 -->
					<div class="clearboth form-box">
						<form class="form-horizontal" id="raiseMoneyForm"  >
							...
							<div class="form-group col-md-12">
								...
								<div>
									<textarea class="form-control field-editable" name="remark" id="remark" rows="2" cols="" data-parsley-maxlength="200">${data.remark}</textarea>
								</div>
							</div>
						</form>
					</div>
		...
		<div class="col-sm-6 col-xs-12">
			...
			<div class="panel-body" id="drawing_audit_panel_box">
			    	...
			    	<div class="clearboth form-box raiseMoneyAuditFormDiv">
			    		<input type="hidden" id="isAudit" name = "isAudit" value = "${isAudit}"/>
			    		<form class="form-horizontal" id="raiseMoneyAuditForm" action="rasieMoneyAuditController/auditSave">
...
<script>
    ...
    $("#raiseMoneyForm,#raiseMoneyAuditForm").toggleEditState();
    $("#raiseMoneyForm,#raiseMoneyAuditForm").styleFit();
    ...
    $.getScript('projectjs/accept/raiseMoney-audit-page.js').done(function () {
    	auditHistory.init();
	});

    //放弃
    $(".cancelBtn").off("click").on("click",function(){
    	$("#ajax-content").cgetContent("rasieMoneyAuditController/main");
	});
    
    //保存
    $(".saveBtn").off("click").on("click",function(){
    	var val=$('#raiseMoneyAuditForm input:radio[name="mrResult"]:checked').val();
    	if(val==null){
    		$("body").cgetPopup({
				title: '提示',
				content: '请选择确认结果！',
    		...
    		$("#raiseMoneyAuditForm").cformSave("auditHistoryTable",auditSaveCallBack,'','','',$(".saveBtn"));
    	}
    });
    ...
    var auditSaveCallBack = function(data){
    	if(data === "true"){
    		$(".saveBtn,.raiseMoneyAuditFormDiv").addClass("hidden");
    		$(".cancelBtn").text("返回");
    		var val=$('#raiseMoneyAuditForm input:radio[name="mrResult"]:checked').val();
    		$("#raiseMoneyAuditForm").toggleEditState(false); 
    	}
    }
