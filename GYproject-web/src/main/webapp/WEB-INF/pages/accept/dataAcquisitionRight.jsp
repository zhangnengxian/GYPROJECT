    ...
    <div class="clearboth form-box">
    	<form class="form-horizontal" id="projectDetailform" data-parsley-validate="true" action="dataAcquisition/saveData">
		    ...
		    <div class="form-group col-md-12  ">
		        ...
		        <div>
		            <input type="text" class="form-control input-sm"  id="projName" name="projName" readonly="true" data-parsley-required="true" data-parsley-maxlength="200" value=""/>
		        </div>
		    </div>
		    <div class="form-group col-md-12  ">
		        <label class="control-label" for="projAddr">工程地点</label>
		        <div>
		            <input type="text" class="form-control input-sm"  id="projAddr" name="projAddr" readonly="true" data-parsley-required="true" value=""/>
		        </div>
		    </div>
		    <div class="form-group col-md-12">
		    ...
		    <div class="form-group col-md-6 noUser">
		        ...
		        <div>
		            <input type="text" class="form-control input-sm field-editable"  id="custContact" name="custContact" data-parsley-maxlength="20" value="" />
		        </div>
		    </div>
		    <div class="form-group col-md-6 noUser">
			...
			<div class="form-group col-md-6 ">
				...
				<div>
					...
					<a href="javascript:;" class="btn btn-sm btn-default">工作日</a>
				</div>
			</div>
		    <div class="form-group col-md-12">
