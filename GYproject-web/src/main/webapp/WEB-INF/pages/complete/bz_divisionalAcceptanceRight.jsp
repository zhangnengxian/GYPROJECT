    ...
    <div class="clearboth form-box">
    	...
    	<form class="form-horizontal" id="diviaionalAcceptanceDetailform" data-parsley-validate="true" action="">
			...
			<div class="form-group col-sm-12 craftWork">
				<label class="control-label" style="text-align: center" for="customerServiceOpinion">质安部意见</label>
				<div>
					<textarea class="form-control field-editable allText inspector technician" name="marketDevDeviceOpinion" id="marketDevDeviceOpinion" rows="2" cols="" data-parsley-maxlength="500" ></textarea>
				</div>
			</div>
			...
			<div class="form-group col-md-6 col-sm-12 civilType clearboth diviContent">
				...
				<div>
					<label>
						<input type="radio" class="field-editable allText inspector technician" name="meAcceptanceSituat" value="1" />整改
					</label>
					<label>
						<input type="radio" class="field-editable allText inspector technician" name="meAcceptanceSituat" value="0" checked/>合格
					</label>
				</div>
			</div>

			<div class="form-group col-md-6 allSign productionStatisticians">
				<label class="control-label signature-tool" for="measurementSign">质量安全部</label>
				<div>
			...
			<hr style="width: 100%;border: none;border-bottom:1px dashed gainsboro "/>
	   		<div class="form-group col-sm-12 craftWork">
               	<label class="control-label" style="text-align: center" for="customerServiceOpinion">客服部意见</label>
                <div>
			...
			<div class="form-group col-md-6 allSign processTechnician">
		  	...
		  	<div class="form-group col-md-6 col-sm-12 allSign builder">
				<label class="control-label signature-tool sign-require" for="cuSpdPrincipal">工程部工程组</label>
				<div>
			...
			<div class="form-group col-md-6 col-sm-12 allSign builder">
				<label class="control-label signature-tool sign-require" for="cuSpdPrincipal">工程部技术组</label>
				<div>
...
<script>
    ...
    $.getScript('assets/plugins/jSignature/jSignature.min.js').done(function() {
    	var signatures = $("#signBtn_1, #signBtn_2, #signBtn_3, #signBtn_4, #signBtn_5,#signBtn_6,#signBtn_7,#signBtn_8,#signBtn_9");
