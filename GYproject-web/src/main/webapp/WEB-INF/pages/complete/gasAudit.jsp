        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">通气审核列表</h4>
                </div>
                    ...
                    <table id="gasAuditTable" data-attach-table="all" class="table table-striped table-bordered nowrap" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="120">验收日期</th>
                                <th width="120">验收类型</th>
                                <th width="60">确认操作</th>
                                <th></th>
                            </tr>
                        </thead>
...
<script>
    ...
    App.setPageTitle('通气审核 - 工程管理系统');
    $.getScript('projectjs/complete/gas-audit.js?v='+Math.random()).done(function() {
        gasAudit.init();
	});
