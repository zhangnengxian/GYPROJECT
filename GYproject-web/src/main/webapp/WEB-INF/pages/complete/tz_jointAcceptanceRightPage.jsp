	...
	<div class="infodetails">
		...
		<div class="clearboth form-box">
			...
			<form class="form-horizontal" id="jointAcceptanceform" action="" data-parsley-validate="true">
				...
				<%-- <div class="form-group col-md-12">
					<label class="control-label">技术组意见</label>
					<div>
			...
			<!-- 	<div class="form-group col-md-6">
				...
				<div class="form-group col-md-12">
					<label class="control-label">巡检调压班意见</label>
					<div>
				...
				<div class="form-group col-md-12">
					<label class="control-label">工程组意见</label>
					<div>
...
<script>
    ...
    var  callBack = function(json){
    	 if($("#post").val().indexOf($("#informCenterSign_postType").val())>=0){
