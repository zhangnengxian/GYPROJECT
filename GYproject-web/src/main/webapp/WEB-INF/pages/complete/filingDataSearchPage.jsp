...
<div class="clearboth form-box">
    <form class="form-horizontal" id="projectSearchPopPage" action="/" method="POST">
        ...
        <div class="form-group col-lg-12 col-md-12 col-sm-6">           
            <label class="control-label" for="subContractDate">合同签订日期</label>
        ...
        <div class="form-group col-lg-12 col-md-12 col-sm-6">           
            <label class="control-label" for="">竣工日期</label>
            <div class="input-group input-daterange">
	            <input type="text" class="form-control datepicker-default input-sm" name="completeDateStart" >
	            <span class="input-group-addon">至</span> 
	            <input type="text" class="form-control datepicker-default input-sm" name="completeDateEnd" >
            </div>
        </div>
    </form>
</div>
