    ...
    <div class="clearboth form-box">
    	...
    	<form class="form-horizontal" id="diviaionalAcceptanceDetailform" data-parsley-validate="true" action="">
		    ...
		    <div class="form-group col-sm-12 craftWork">
               	<label class="control-label" for="transmissionOpinion">输配中心</label>
                <div> 
		    ...
		    <div class="form-group col-md-6  hidden cuAcceptanceSituat cuRectificationDate civilType">
	   		...
	   		<div class="form-group col-sm-12 craftWork">
               	<label class="control-label" for="marketOpinion">市场发展部</label>
                <div> 
                   	<textarea class="form-control field-editable allText  minister" name="marketOpinion" id="marketOpinion" rows="2" cols="" data-parsley-maxlength="500" ></textarea>
                </div>
	   		</div>
	   		<div class="form-group col-md-6 col-sm-12 civilType clearboth diviContent">
		        <label class="control-label" for="">验收情况</label>
		    	<div>
		        	<label>
		            	<input type="radio" class="field-editable allText  minister" name="meAcceptanceSituat" value="1" />整改
		            </label>
		            <label>
		            	<input type="radio" class="field-editable allText  minister" name="meAcceptanceSituat" value="0" checked/>合格
		            </label>
		        </div>
		    </div>
		    <div class="form-group col-sm-12 hidden meAcceptanceSituat meRectificationOpinion civilType">
		        ...
		        <div>
		           <textarea  class=" form-control field-editable allText  minister" id="meRectificationOpinion"  name="meRectificationOpinion" rows="2" cols="" data-parsley-maxlength="500" data-parsley-required="true" ></textarea>
		        </div>
		    </div>
		    <div class="form-group col-md-6  hidden meAcceptanceSituat meRectificationDate civilType">
		        <label class="control-label" for="">整改日期</label>
		        <div>
		           <input type="text" class=" form-control input-sm datepicker-default field-editable allText minister timestamp"  id="meRectificationDate"  name="meRectificationDate" data-parsley-required="true" >
		        </div>
		    </div>
	   		<div class="form-group col-sm-12 craftWork">
		    ...
		    <div class="form-group col-md-6 allSign market minister">
				<label class="control-label signature-tool" for="measurementSign">市场发展部</label>
				<div>
					<a href="javascript:;" class="btn btn-sm btn-white fieldPrincipal-a" id="signBtn_6"><i class="fa fa-pencil"></i></a>
					<input type="hidden" class="sign-data-input" id="marketSign" name="marketSign" value="">
					<input type="hidden" class="signPost" id="marketSign_postType" name="marketSign_postType" value="${MarketMinister }" >
			...
			<div class="form-group col-md-6 allSign processTechnician">
				<label class="control-label signature-tool" for="transCompanySign">输配中心</label>
				<div>
