    ...
    <div class="row">
        ...
        <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">一站式验收单列表</h4>
                </div>
                <div class="panel-body">
                    ...
                    <table id="oneStopAcceptancePrintTable" data-attach-table="all" class="table table-striped table-bordered nowrap" width="100%">
                        <thead>
                            <tr>
                            	<th>一站式验收单ID</th>
                                <th>工程编号</th>
...
<script>
	...
	App.setPageTitle('一站式验收单打印 - 工程管理系统');
	...
	$.getScript('projectjs/complete/one-stop-acceptance-print.js?v=1054').done(function () {
		oneStopAcceptancePrint.init();
	});
    ...
    var showReport = function(){
    	...
    	console.info(jaId);
    	imgUrl = $(".imgUrl").val();
    	src = cptPath+"/ReportServer?reportlet=complete/oneStopAcceptancePrint.cpt&jaId=" + jaId + "&projId=" + projId + "&projName=" + projName;
    	src = src + "&imgUrl="+imgUrl+"&jaId="+jaId;
        $("#mainFrm").attr("src",src);
    }
//    var src1 = cptPath+"/ReportServer?reportlet=complete/oneStopAcceptancePrint.cpt";
