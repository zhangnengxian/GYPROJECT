		...
		<div class="clearboth form-box">
			...
			<form class="form-horizontal" id="jointAcceptanceform" action="" data-parsley-validate="true">
				...
				<div class="form-group col-md-6">
					<label class="control-label signature-tool">签字日期</label>
					<div>
						<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText builder viceMinister signDate"  id="fieldPrincipalSignDate" name="fieldPrincipalSignDate" />
					</div>
				</div>
