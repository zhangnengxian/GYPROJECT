	...
	<div class="infodetails">
		...
		<div class="clearboth form-box">
			...
			<form class="form-horizontal" id="jointAcceptanceform" action="" data-parsley-validate="true">
				...
				<div class="form-group col-md-12">
					<label class="control-label">客服部巡线班意见</label>
					<div>
				...
				<div class="form-group col-md-12">
					<label class="control-label">客户服务综合组意见</label>
					<div>
						<input type="text" class="form-control field-editable noIdea allText processTechnician" name ="custCenterDevice" id="custCenterDevice" data-parsley-maxlength="100"/>
					</div>
				</div>
				<div class="form-group col-md-6 allSign processTechnician">
				...
				<div class="form-group col-md-6">
					<label class="control-label signature-tool ">签字日期</label>
					<div>
						<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText processTechnician signDate"  id="custCenterSignDate" name="custCenterSignDate" />
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<div>
						<input type="text" class="form-control field-editable noIdea allText builder" name ="fieldPrincipalDevice" id="fieldPrincipalDevice" data-parsley-maxlength="100"/>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="form-group col-md-6 allSign minister">
						...
						<div>
							...
							<input type="hidden" class="signPost" id="marketDevSign_postType" name="marketDevSign_postType" value="${marketDevSign}" >
							<img class="fieldPrincipal" alt="" src="" style="height: 30px">
							<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
						</div>
					</div>
