		...
		<div class="clearboth form-box">
			...
			<form class="form-horizontal" id="jointAcceptanceform" action="" data-parsley-validate="true">
				...
				<div class="form-group col-md-6">
					...
					<div>
						<input type="text" class="form-control noIdea input-sm field-editable datepicker-default allText technician signDate"  id="jaDate" name="jaDate" data-parsley-required="true"/>
					</div>
				</div>
