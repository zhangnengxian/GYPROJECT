		...
		<div class="clearboth form-box">
			...
			<form class="form-horizontal" id="jointAcceptanceform" action="" data-parsley-validate="true">
				...
				<div class="form-group col-md-6">
					...
					<div>
						<input type="text" class="form-control noIdea input-sm field-editable datepicker-default allText builder signDate"  id="jaDate" name="jaDate" data-parsley-required="true"/>
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					<label class="control-label">生成运营部</label>
					<div>
				...
				<div class="form-group col-md-6 allSign technician">
					<label class="control-label signature-tool sign-require" for="marketDevSign">组织人</label>
					<div>
				...
				<div class="form-group col-md-12  market">
					...
					<div class="form-group col-md-6 allSign market">
						...
						<div>
							...
							<input type="hidden" class="signPost" id="measurementSign_postType" name="measurementSign_postType" value="${marketDevSign}" >
					...
					<div class="form-group col-md-12  minister">
						<label class="control-label">财务部意见</label>
						<div>
							<input type="text" class="form-control field-editable noIdea allText minister" name ="financialAdvice" id="financialAdvice" data-parsley-maxlength="100"/>
						</div>
					</div>
					<div class="form-group col-md-6 allSign minister">
						<label class="control-label signature-tool sign-require" for="financialSign">验收人</label>
						<div>
							<a href="javascript:;" class="btn btn-sm btn-white fieldPrincipal-a" id="signBtn_9"><i class="fa fa-pencil"></i></a>
							<input type="hidden" class="sign-data-input" id="financialSign" name="financialSign" value="">
							<input type="hidden" class="signPost" id="financialSign_postType" name="financialSign_postType" value="${minister}" >
							<img class="measurementSign" alt="" src="" style="height: 30px">
							<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
						</div>
					</div>
					<div class="form-group col-md-6">
						<label class="control-label signature-tool">签字日期</label>
						<div>
							<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText minister signDate"  id="financialSignDate" name="financialSignDate" />
						</div>
					</div>
				<div class="form-group col-md-12">
...
<script>
   ...
   if($("#post").val().indexOf(',54,')){
    ...
    trSData.t && trSData.t.cgetDetail('jointAcceptanceform','jointAcceptance/jointDetail','');
    tableCallBack();
	//验收
