    	...
    	<form class="form-horizontal" id="diviaionalAcceptanceDetailform" data-parsley-validate="true" action="">
			...
			<hr style="width: 100%;border: none;border-bottom:1px dashed gainsboro "/>
	   		<div class="form-group col-sm-12 craftWork">
               	<label class="control-label" style="text-align: center" for="customerServiceOpinion">客户服务综合组意见</label>
                <div>
			...
			<hr style="width: 100%;border: none;border-bottom:1px dashed gainsboro "/>
			<div class="form-group col-sm-12 craftWork">
				<label class="control-label" style="text-align: center" for="transmissionOpinion">客户服务巡线班意见</label>
				<div>
					<textarea class="form-control field-editable allText inspector technician" name="transmissionOpinion" id="transmissionOpinion" rows="2" cols="" data-parsley-maxlength="500" ></textarea>
				</div>
			</div>
			<div class="form-group col-md-6 allSign processTechnician">
			...
			<div class="form-group col-md-6 col-sm-12 civilType clearboth diviContent">
				...
				<div>
					<label>
						<input type="radio" class="field-editable allText inspector technician" name="trAcceptanceSituat" value="1" />整改
					</label>
					<label>
						<input type="radio" class="field-editable allText inspector technician" name="trAcceptanceSituat" value="0" checked/>合格
					</label>
				</div>
			</div>
			<hr style="width: 100%;border: none;border-bottom:1px dashed gainsboro "/>
