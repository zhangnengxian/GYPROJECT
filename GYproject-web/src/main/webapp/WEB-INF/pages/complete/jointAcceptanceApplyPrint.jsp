    ...
    <div class="row">
        ...
        <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">联合验收申请打印列表</h4>
                </div>
                <div class="panel-body">
                    ...
                    <table id="jointAcceptanceApplyPrintTable" data-attach-table="all" class="table table-striped table-bordered nowrap" width="100%">
                        <thead>
                            <tr>
                            	<th>联合验收ID</th>
                                <th>工程编号</th>
...
<script>
	...
	$.getScript('projectjs/complete/jointAcceptance-apply-print.js?'+Math.random()).done(function () {
		divisionalAcceptanceApplyList.init();
	});

    function cjkEncode(D){if(typeof D!=="string"){return D}var C="";for(var A=0;A<D.length;A++){var B=D.charCodeAt(A);if(B>=128||B==91||B==93){C+="["+B.toString(16)+"]"}else{C+=D.charAt(A)}}return C}
    var showReport = function(){
    	var jaId=$("#jaId").val(),projId=$("#projId").val(),imgUrl = $(".imgUrl").val();
    	//imgUrl = encodeURIComponent(cjkEncode(imgUrl));
    	
    	console.info("imgUrl--"+imgUrl);
    	src = cptPath+"/ReportServer?reportlet=complete/"+cptType+"&jaId=" + jaId + "&projId=" + projId+"&imgUrl="+imgUrl;
