...
<div class="panel-body" id="box">
	<div class="infodetails">
		<div class="toolBtn f-r p-b-10 editbtn">
			...
			<a href="javascript:;" class="btn btn-query btn-sm m-l-5 hidden saveButton jointPushButtn">推送</a>
		...
		<div class="clearboth form-box">
			...
			<input type="hidden" id="organizationMan" value="${organizationMan}">
			...
			<form class="form-horizontal" id="jointAcceptanceform" action="" data-parsley-validate="true">
				...
				<div class="form-group col-md-6">
					...
					<div>
						<input type="text" class="form-control noIdea input-sm field-editable datepicker-default allText technician signDate"  id="jaDate" name="jaDate"/>
					</div>
				</div>
				<div class="form-group col-md-12">
					<label class="control-label">设计单位意见</label>
					<div>
						<input type="text" class="form-control field-editable noIdea allText designer" name ="pdUnitDevice" id="pdUnitDevice" data-parsley-maxlength="100"/>
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<div>
						<input type="text" class="form-control field-editable noIdea allText suJgj" name ="suNameDevice" id="suNameDevice" data-parsley-maxlength="100"/>
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<div>
						<input type="text" class="form-control field-editable noIdea allText technician" name ="informCenterDevice" id="informCenterDevice" data-parsley-maxlength="100"/>
					</div>
				</div>
				<div class="form-group col-md-6 allSign technician">
					<label class="control-label signature-tool sign-require" for="informCenterSign">验收人</label>
					<div>
						...
						<input type="hidden" class="signPost" id="informCenterSign_postType" name="informCenterSign_postType" value="${organizationMan }" >
						<img class="fieldPrincipal" alt="" src="" style="height: 30px">
						<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
					</div>
				</div>
				<div class="form-group col-md-6">
					<label class="control-label signature-tool">签字日期</label>
					<div>
						<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText technician signDate" id="informCenterSignDate" name="informCenterSignDate" />
					</div>
				</div>
				<div class="form-group col-md-12">
					<label class="control-label">输配中心意见</label>
					<div>
						<input type="text" class="form-control field-editable noIdea allText processTechnician" name ="transCompanyDevice" id="transCompanyDevice" data-parsley-maxlength="100"/>
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<div>
						<input type="text" class="form-control field-editable noIdea allText inspector" name ="custCenterDevice" id="custCenterDevice" data-parsley-maxlength="100"/>
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<div>
						<input type="text" class="form-control field-editable noIdea allText viceMinister" name ="fieldPrincipalDevice" id="fieldPrincipalDevice" data-parsley-maxlength="100"/>
					</div>
				</div>
				<div class="form-group col-md-6 allSign viceMinister">
					...
					<div>
						...
						<input type="hidden" class="signPost" id="fieldPrincipalSign_postType" name="fieldPrincipalSign_postType" value="${viceMinister }" >
						<img class="fieldPrincipal" alt="" src="" style="height: 30px">
						<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
					</div>
				</div>
				<div class="form-group col-md-6">
					<label class="control-label signature-tool">签字日期</label>
					<div>
						<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText viceMinister signDate"  id="fieldPrincipalSignDate" name="fieldPrincipalSignDate" />
					</div>
				</div>

					<div class="form-group col-md-12  fieldPrincipalDevice ">
						<label class="control-label">市场发展部意见</label>
						<div>
							<input type="text" class="form-control field-editable noIdea allText viceMinister" name ="marketDevDevice" id="marketDevDevice" data-parsley-maxlength="100"/>
						</div>
					</div>
					<div class="form-group col-md-6 allSign minister">
						<label class="control-label signature-tool" for="marketDevSign">验收人</label>
						<div>
							<a href="javascript:;" class="btn btn-sm btn-white fieldPrincipal-a" ><i class="fa fa-pencil"></i></a>
							<input type="hidden" class="sign-data-input" id="marketDevSign" name="marketDevSign" value="">
							<input type="hidden" class="signPost" id="marketDevSign_postType" name="marketDevSign_postType" value="${minister}" >
							<img class="fieldPrincipal" alt="" src="" style="height: 30px">
							<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
						</div>
					</div>
					<div class="form-group col-md-6">
						<label class="control-label signature-tool">签字日期</label>
						<div>
							<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText minister signDate"  id="marketDevSignDate" name="marketDevSignDate" />
						</div>
					</div>
				<div class="form-group col-md-12">
...
<script>
    ...
    var jsonl=trSData.jointAcceptanceTable.json;
    var  callBack = function(json){
        if($("#post").val().indexOf($("#organizationMan").val())>=0){
            $(".jointPushButtn").removeClass("hidden");
       	 if(jsonl.projChanges.indexOf(3) >= 0 || jsonl.projChanges.indexOf(0) >= 0 || jsonl.projChanges == '' || jsonl.projChanges == null){
