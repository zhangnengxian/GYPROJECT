    	...
    	<form class="form-horizontal" id="openPlanForm" action="openPlan/saveGasProject">
		   ...
		   <!--  <div class="form-group col-md-6 col-sm-12">
		    ...
		    <div class="form-group col-md-6 col-sm-12">
		    	...
		    	<div>
		    		<input type="text" class="form-control input-sm field-editable"  id="pipeMaterial" name="pipeMaterial"  data-parsley-maxlength="500" value=""/>
		        </div>
		    </div>
		    <div class="form-group col-md-6 col-sm-12 isHdden">
		    	...
		    	<div>
		    		<input type="text" class="form-control input-sm field-editable"  id="pipeSize" name="pipeSize"  data-parsley-maxlength="500" value=""/>
		        </div>
		    </div>
		    <div class="form-group col-md-6 col-sm-12 isHdden">
		    	<!-- 新加字段 -->
		    	...
		    	<div>
		    		<input type="text" class="form-control input-sm field-editable"  id="pipeRating" name="pipeRating" data-parsley-maxlength="500" value=""/>
		        </div>
		    </div>
		    <div class="form-group col-md-6 col-sm-12 isHdden">
		    	<!-- 新加字段 -->
		    ...
		    <div class="form-group col-md-6 col-sm-12">
		    	...
		    	<div>
		    		<input type="text" class="form-control input-sm field-editable"  id="gasPoint" name="gasPoint" data-parsley-maxlength="500" value=""/>
		        </div>
		    </div>
		    ...
		    <div class="form-group col-md-6 col-sm-12 hidden deliveryTime clearboth">
		     ...
		     <div class="form-group col-md-12 hidden reason">
				...
				<div>
					<textarea class="form-control input-sm field-editable" data-parsley-required="true" placeholder="请填写原因" id="reason" name="reason" data-parsley-maxlength="500" ></textarea>
				</div>
		    </div>
		    <div class="form-group col-md-12 isHdden">
				...
				<div>
					<textarea class="form-control input-sm field-editable" id="gasContent" name="gasContent" data-parsley-maxlength="500" ></textarea>
				</div>
		    </div>
			<div class="form-group col-md-12 isHdden">
		    	<!-- 新加字段 -->
				...
				<div>
					<textarea class="form-control input-sm field-editable" id="gasRemark" name="gasRemark" data-parsley-maxlength="500" ></textarea>
				</div>
		    </div>
		</form>
