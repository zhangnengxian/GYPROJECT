...
<script>
    ...
    App.setPageTitle('交接单打印 - 工程管理系统');
    
    $.getScript('projectjs/complete/connect-confirm-print.js').done(function () {
    	connectConfirm.init();
	});
    ...
    src = cptPath+"/ReportServer?reportlet=complete/completionTransfer.cpt";
