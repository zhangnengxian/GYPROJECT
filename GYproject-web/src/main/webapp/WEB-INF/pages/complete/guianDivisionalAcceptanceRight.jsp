    ...
    <div class="clearboth form-box">
        ...
        <form class="form-horizontal" id="diviaionalAcceptanceDetailform" data-parsley-validate="true" action="">
            ...
            <div class="form-group  col-md-6 ">
                ...
                <div>
                    <input type="text" class="form-control input-sm field-not-editable" id="projNo" name="projNo"
                           data-parsley-maxlength="50" value=""/>
                </div>
            </div>
            <div class="form-group col-md-6 ">
            ...
            <div class="form-group col-md-12 ">
                ...
                <div>
                    <input type="text" class="form-control input-sm field-not-editable" id="projName" name="projName"
                           data-parsley-maxlength="200" value=""/>
                </div>
            </div>
            <div class="form-group col-md-12">
            ...
            <div class="form-group col-md-12">
                ...
                <div>
                    <textarea class="form-control input-sm field-not-editable" name="projScaleDes" rows="" cols=""
            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <div>
                    <input type="text" class="form-control input-sm field-not-editable" id="duDesigner"
                           name="duDesigner" data-parsley-maxlength="100"/>
                </div>
            </div>
            <div class="form-group col-md-6 ">
            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <div>
                    <input type="text" class="form-control input-sm field-not-editable" id="managementQae1"
                           name="managementQae1" data-parsley-maxlength="100"/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12">
            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <div>
                    <input type="text" class="form-control input-sm field-not-editable" id="managementWacf"
                           name="managementWacf" data-parsley-maxlength="100"/>
                </div>
            </div>
            <!--！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！  -->
            <div class="form-group col-md-6 col-sm-12">
            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <div>
                    <input type="text" class="form-control input-sm field-not-editable" id="projectTypeDes"
                           name="projectTypeDes" value=""/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12">
                <label class="control-label" for="">出资方式</label>
                <div>
                    <input type="text" class="form-control input-sm field-not-editable" id="contributionModeDes"
                           name="contributionModeDes" value=""/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12">
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text" class="form-control input-sm  datepicker-default field-not-editable"
                           id="acceptanceDate" name="acceptanceDate" data-parsley-required="true"/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 ">
                <label class="control-label">强度试验</label>
                <div>
                    <label><input type="radio" class="field-editable" name="strengthTest" value="1" checked> 有</label>
                    <label><input type="radio" class="field-editable" name="strengthTest" value="2"> 无</label>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 ">
                <label class="control-label">吹扫记录</label>
                <div>
                    <label><input type="radio" class="field-editable" name="purgeRecord" value="1" checked> 有</label>
                    <label><input type="radio" class="field-editable" name="purgeRecord" value="2"> 无</label>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12">
                <label class="control-label">施工自检表</label>
                <div>
                    <label><input type="radio" class="field-editable" name="selfCheckTable" value="1" checked> 有</label>
                    <label><input type="radio" class="field-editable" name="selfCheckTable" value="2"> 无</label>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 ">
                <label class="control-label">三份竣工图</label>
                <div>
                    <label><input type="radio" class="field-editable" name="completionDrawing" value="1" checked>
                        有</label>
                    <label><input type="radio" class="field-editable" name="completionDrawing" value="2"> 无</label>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 ">
                <label class="control-label">分部验收申请表</label>
                <div>
                    <label><input type="radio" class="field-editable" name="acceptanceTable" value="1" checked>
                        有</label>
                    <label><input type="radio" class="field-editable" name="acceptanceTable" value="2"> 无</label>
                </div>
            </div>

            <div class="form-group col-sm-12">
                <label class="control-label" for="thisAcceptanceContent">验收情况</label>
                <div>
                    <textarea class="form-control field-editable" name="thisAcceptanceContent"
                              id="thisAcceptanceContent" rows="2" cols="" data-parsley-maxlength="500"></textarea>
                </div>
            </div>
            <div class="form-group col-md-6 allSign ceneralEngineer ">
                <label class="control-label signature-tool sign-require" for="ceneralEngineer">总工程师</label>
                <div>
                    <a href="javascript:;" class="btn btn-sm btn-white fieldPrincipal-a" id="signBtn_1"><i
                            class="fa fa-pencil"></i></a>
                    <input type="hidden" class="sign-data-input" id="ceneralEngineer" name="ceneralEngineer" value="">
                    <input type="hidden" class="signPost" id="ceneralEngineer_postType" name="ceneralEngineer_postType"
                           value="${ceneralEngineer}">
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText inspector signDate"
                           id="ceneralEngineerSignDate" name="ceneralEngineerSignDate"/>
                </div>
            </div>

            <!--<div class="form-group col-md-12">
                <label class="control-label" for="regulatClassOpinion">巡线调压班意见</label>
                <div>
                    <textarea class="form-control field-editable noIdea allText " name="regulatClassOpinion"
                              id="regulatClassOpinion" data-parsley-maxlength="500" rows="2" cols=""/>
                </div>
            </div>
            <div class="form-group col-md-6 allSign ">
                <label class="control-label signature-tool sign-require" for="transCompanySign">验收人</label>
                <div>
                    <a href="javascript:;" class="btn btn-sm btn-white fieldPrincipal-a" id="signBtn_2"><i
                            class="fa fa-pencil"></i></a>
                    <input type="hidden" class="sign-data-input" id="regulatClass" name="regulatClass" value="">
                    <input type="hidden" class="signPost" id="regulatClass_postType" name="regulatClass_postType"
                           value="${regulatClass }">
                    <img class="fieldPrincipal" alt="" src="" style="height: 30px">
                    <span class="clear-sign"><i class="fa ion-close-circled"></i></span>
                </div>
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText  signDate"
                           id="regulatClassSignDate" name="regulatClassSignDate"/>
                </div>
            </div>

            <div class="form-group col-md-12">
                <label class="control-label" for="transmissionOpinion">输配中心综合意见</label>
                <div>
                    <textarea class="form-control field-editable noIdea allText processTechnician"
                              name="transmissionOpinion" id="transmissionOpinion" data-parsley-maxlength="500" rows="2"
                              cols=""/>
                </div>
            </div>
            <div class="form-group col-md-6 allSign processTechnician">
                ...
                <div>
                    ...
                    <input type="hidden" class="signPost" id="transCompanySign_postType"
                           name="transCompanySign_postType" value="${transCompanySign }">
                    <img class="fieldPrincipal" alt="" src="" style="height: 30px">
                    <span class="clear-sign"><i class="fa ion-close-circled"></i></span>
                </div>
            </div>
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText processTechnician signDate"
                           id="transCompanySignDate" name="transCompanySignDate"/>
                </div>
            </div>-->
         ...
         <div class="form-group col-md-6  hidden trAcceptanceSituat trRectificationDate civilType">
          ...
          <!--  <div class="form-group col-sm-12 craftWork">
                <label class="control-label" for="customerServiceOpinion">客户服务部意见</label>
                <div>
                    <textarea class="form-control field-editable allText inspector technician"
                              name="customerServiceOpinion" id="customerServiceOpinion" rows="2" cols=""
            ...
            <div class="form-group col-md-6 allSign inspector">
                ...
                <div>
                    ...
                    <input type="hidden" class="signPost" id="custCenterSign_postType" name="custCenterSign_postType"
                           value="${custCenterSign }">
                    <img class="fieldPrincipal" alt="" src="" style="height: 30px">
                    <span class="clear-sign"><i class="fa ion-close-circled"></i></span>
                </div>
            </div>
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText inspector signDate"
                           id="custCenterSignDate" name="custCenterSignDate"/>
                </div>
            </div>-->
            ...
            <div class="form-group col-md-12">
                ...
                <div>
                    <textarea class="form-control field-editable noIdea allText designer" name="pdUnitDeviceOpinion"
                              id="pdUnitDeviceOpinion" data-parsley-maxlength="100"/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 allSign designer">
                <label class="control-label signature-tool sign-require" for="duDeputy">验收人</label>
                <div>
                    ...
                    <input type="hidden" class="signPost" id="duDeputy_postType" name="duDeputy_postType"
                           value="${duDeputy }">
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText designer signDate"
                           id="pdUnitSignDate" name="pdUnitSignDate"/>
                </div>
            </div>
            <div class="form-group col-md-12">
                <label class="control-label">监理公司意见</label>
                <div>
                    <textarea class="form-control field-editable noIdea allText suJgj" name="suNameDeviceOpinion"
                              id="suNameDeviceOpinion" data-parsley-maxlength="100"/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 allSign suJgj">
                <label class="control-label signature-tool sign-require" for="suFieldJgj">验收人</label>
                <div>
                    ...
                    <input type="hidden" class="signPost" id="suFieldJgj_postType" name="suFieldJgj_postType"
                           value="${suFieldJgj }">
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText suJgj signDate"
                           id="suNameSignDate" name="suNameSignDate"/>
                </div>
            </div>
            ...
            <div class="form-group col-md-12">
                ...
                <div>
                    <textarea class="form-control field-editable noIdea allText suJgj" name="managementQaeOpinion"
                              id="managementQaeOpinion" data-parsley-maxlength="100"/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 allSign construction">
                ...
                <div>
                    ...
                    <input type="hidden" class="signPost" id="managementQae_postType" name="managementQae_postType"
                           value="${managementQae }">
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText suJgj signDate"
                           id="managementQaeSignDate" name="managementQaeSignDate"/>
                </div>
            </div>
            ...
            <div class="form-group col-md-12">
                ...
                <div>
                    <textarea class="form-control field-editable noIdea allText builder"
                              name="fieldPrincipalDeviceOpinion" id="fieldPrincipalDeviceOpinion"
                              data-parsley-maxlength="100"/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 allSign builder">
                <label class="control-label signature-tool sign-require" for="cuSpdPrincipal">验收人</label>
                <div>
                    <a href="javascript:;" class="btn btn-sm btn-white" id="signBtn_1"><i class="fa fa-pencil"></i></a>
                    <input type="hidden" class="sign-data-input" id="cuSpdPrincipal" name="cuSpdPrincipal" value="">
                    <input type="hidden" class="signPost" id="cuSpdParticipant_postType"
                           name="cuSpdParticipant_postType" value="${cuSpdPrincipal}">
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText builder signDate"
                           id="fieldPrincipalSignDate" name="fieldPrincipalSignDate"/>
                </div>
            </div>
           <!-- <div class="form-group col-md-12">
                <label class="control-label">质安部意见</label>
                <div>
                    <textarea class="form-control field-editable noIdea allText technician"
                              name="marketDevDeviceOpinion" id="marketDevDeviceOpinion" data-parsley-maxlength="100"/>
                </div>
            </div>
            <div class="form-group col-md-6 col-sm-12 allSign technician">
                ...
                <div>
                    ...
                    <input type="hidden" class="signPost" id="organizationMan_postType" name="organizationMan_postType"
                           value="${organizationMan }">
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type="text"
                           class="form-control input-sm field-editable noIdea datepicker-default allText technician signDate"
                           id="marketDevSignDate" name="marketDevSignDate"/>
                </div>
            </div>-->
            <div class="form-group col-md-12">
                <label class="control-label" for="remark">备注</label>
                <div>
                    <textarea class="form-control field-editable  " name="remark" id="remark"
                              data-parsley-maxlength="500" rows="2" cols=""/>
                </div>
            </div>
            <!-- <div class="form-group col-md-6 col-sm-12 civilType clearboth diviContent">
             <label class="control-label" for="">验收情况</label>
