...
<div class="infodetails">
	<div class="toolBtn f-r p-b-10 editbtn">
		...
		<a href="javascript:;" class="btn btn-info btn-sm m-l-5 pushButton" >推送</a>
    ...
    <div class="clearboth form-box">
    	...
    	<form class="form-horizontal" id="diviaionalAcceptanceDetailform" data-parsley-validate="true" action="">
		    ...
		    <div class="form-group col-md-6 col-sm-12">
		        ...
		        <div>
		        	<input type="text" class="form-control input-sm field-not-editable"  id="suJgj" name="suJgj"  data-parsley-maxlength="100" />
		        </div>
		    </div>
		    <div class="form-group col-md-6 col-sm-12">
		    ...
		    <div class="form-group col-md-6">
		        ...
		        <div>
		            <input type="text" class="form-control input-sm  datepicker-default field-not-editable"  id="acceptanceDate" name="acceptanceDate" data-parsley-required="true" />
		        </div>
		    </div>
		    <div class="form-group col-md-6 col-sm-12 ">
		     ...
		     <div class="form-group col-md-6 col-sm-12 ">
				...
				<div>
					<label><input type="radio" class="field-editable" name="completionDrawing" value="1" checked> 有</label>
		    ...
		    <div class="form-group col-md-6 col-sm-12 ">
				...
				<div>
					<label><input type="radio" class="field-editable" name="acceptanceTable" value="1" checked> 有</label>
			...
			<div class="form-group col-md-6 allSign ceneralEngineer ">
				...
				<div>
					...
					<input type="hidden" class="signPost" id="ceneralEngineer_postType" name="ceneralEngineer_postType" value="${ceneralEngineer}" >
				...
				<div class="form-group col-md-6">
					...
					<div>
						<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText inspector signDate"  id="ceneralEngineerSignDate" name="ceneralEngineerSignDate" />
					</div>
				</div> --%>
				...
				<%-- 	<div class="form-group col-md-12">
					...
					<div>
						<textarea class="form-control field-editable noIdea allText " name ="regulatClassOpinion" id="regulatClassOpinion" data-parsley-maxlength="500" rows="2" cols=""/>
					</div>
				</div>
				...
				<div>
					...
					<input type="hidden"class="signPost"  id="regulatClass_postType" name="regulatClass_postType" value="${regulatClass }" >
					<img class="fieldPrincipal" alt="" src="" style="height: 30px">
					<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
				</div>
			</div>
				<div class="form-group col-md-6">
					<label class="control-label signature-tool">签字日期</label>
					<div>
						<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText  signDate"  id="regulatClassSignDate" name="regulatClassSignDate" />
					</div>
				</div> --%>
	   			...
	   			<!-- <div class="form-group col-md-12">
					...
					<div>
						<textarea class="form-control field-editable noIdea allText processTechnician" name ="transmissionOpinion" id="transmissionOpinion" data-parsley-maxlength="500" rows="2" cols=""/>
					</div>
				</div> -->
		    ...
		    <div class="form-group col-md-6  hidden trAcceptanceSituat trRectificationDate civilType">
	   		...
	   		<div class="form-group col-md-6 allSign testLeader">
	   	...
	   	<!-- 	<div class="form-group col-md-6 col-sm-12 civilType clearboth diviContent">
		    ...
		    <div class="form-group col-md-6  hidden cuAcceptanceSituat cuRectificationDate civilType">
	   		...
	   		<div class="form-group col-md-12">
				<label class="control-label">设计公司意见</label>
				  <div>
					 <textarea class="form-control field-editable noIdea allText designer" name ="pdUnitDeviceOpinion" id="pdUnitDeviceOpinion" data-parsley-maxlength="100"/>
				 </div>
			</div>
			<div class="form-group col-md-6 col-sm-12 allSign designer">
				...
				<div class="form-group col-md-12">
					...
					<div>
						<textarea class="form-control field-editable noIdea allText suJgj" name ="suNameDeviceOpinion" id="suNameDeviceOpinion" data-parsley-maxlength="100"/>
					</div>
				</div>
			...
			<%-- 	<div class="form-group col-md-12">
					...
					<div>
						<textarea class="form-control field-editable noIdea allText suJgj" name ="managementQaeOpinion" id="managementQaeOpinion" data-parsley-maxlength="100"/>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					<label class="control-label signature-tool">签字日期</label>
					<div>
						<input type="text" class="form-control input-sm field-editable noIdea datepicker-default allText suJgj signDate"  id="managementQaeSignDate" name="managementQaeSignDate"  />
					</div>
				</div> --%>
				...
				<div class="form-group col-md-12">
					...
					<div>
						<textarea class="form-control field-editable noIdea allText builder" name ="fieldPrincipalDeviceOpinion" id="fieldPrincipalDeviceOpinion" data-parsley-maxlength="100"/>
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<div>
						<textarea class="form-control field-editable noIdea allText technician" name ="marketDevDeviceOpinion" id="marketDevDeviceOpinion" data-parsley-maxlength="100"/>
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<div>
						<textarea class="form-control field-editable  " name ="remark" id="remark" data-parsley-maxlength="500" rows="2" cols=""/>
					</div>
				</div>
	   		<!-- <div class="form-group col-md-6 col-sm-12 civilType clearboth diviContent">
		        <label class="control-label" for="">验收情况</label>
