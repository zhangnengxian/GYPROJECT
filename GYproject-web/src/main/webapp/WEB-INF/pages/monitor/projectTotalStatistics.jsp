...
<div style='position:relative;float:left;top:30px'><span style='float:center'><font size='5'>&nbsp;&nbsp;&nbsp;工程量统计分析（区域、规模）</font></span></div>
<div class="echart-box" id="projTotal" style='width:1000px;height:800px;text-align:center;top:-10px'></div>
</div>
</body>
</html>
 <!-- ================== BEGIN BASE JS ================== -->
