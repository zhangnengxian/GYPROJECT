...
<body>
<div class="content">
	<div class="fullScreenShow col-md-12 col-lg-12 hidden" id="fullScreenShow">
	</div>
	<div class="row ">
		<div class="col-lg-4 col-md-4 firstBox" id="firstBox">
		
		</div>
		<div class="col-lg-4 col-md-4 secondBox" id="secondBox">
		
		</div>
		<div class="col-lg-4 col-md-4 thirdBox" id="thirdBox">
		...
		<div class="col-lg-6 col-md-6 fifthBox" id="fifthBox">
		
		</div>
		<div class="col-lg-6 col-md-6 sixthBox" id="sixthBox">
...
<div id="wrapper hidden">
	<div class=" col-md-12 col-lg-12 hidden" id="">
	</div>
    <div class="column">
        <div class="echart-box x4">
    		<div class="column x2">
        		<div class="echart-box">
        			<div id="fullScreenLeftBox" class="chart-panel"></div>
        		</div>
    		</div>
    		<div class="column x3">
        		<div class="echart-box">
        			<div id='fullScreenEchartBox' class="chart-panel"></div>
        		</div>
       		</div>
    		<div class="column x2">
        		<div class="echart-box">
        			<div id="fullScreenAreaShow" class="chart-panel"></div>
        		</div>
        	</div>
        	<div id="backHomeBtn" class="backHomeBtn hidden">
        ...
        <div class="echart-box x1 hidden">
    		<div class="column">
    			<div class="circleChoose">
                    <table class="no-border" width="100%" border='0' style="margin-top:-34px">
                    	<tr height='96px'>
                    		<td  class="changeBackground0 circle" id='td_0' style='text-Align:center;background-repeat:no-repeat;'><label id='lab0'></label></td>
                    		<td  class="line" style='background:url(/images/common/monitor/arrow.png) center;background-size:50px 60px;background-repeat:no-repeat;'></td>
                    		<td  class="changeBackground1 circle"   id='td_1' style='text-Align:center;background-repeat:no-repeat;'><label id='lab1'></label></td>
        ...
        <div class="echart-box x3">
    		<div class="column">
        		<div class="echart-box">
        			<div id='fullScreenSignShow' class="chart-panel"></div>
        		</div>
       		</div>
    		<div class="column">
        		<div class="echart-box">
        			<div id='fullScreenAmountShow' class="chart-panel"></div>
        		</div>
       		</div>
        </div>
    </div>
