...
<div style='position:relative;float:left;top:30px'><span style='float:center'><font size='5'>&nbsp;&nbsp;&nbsp;工程项目实收实付金额分析图</font></span></div>
<div id="projPayment" style='width:1024;height:600px;text-align:center;top:50px'></div>
</div>
</body>
</html>
 <!-- ================== BEGIN BASE JS ================== -->
