       	...
       	<div class="panel panel-inverse tabs-mixin" id="">
            ...
            <div class="panel-body">
					<div class="toolBtn f-r p-b-10  editbtn">
						<a href="javascript:;" class="btn btn-confirm btn-sm m-l-5 acceptSaveBtn hidden" >保存</a>
					</div>
				    <div class="clearboth form-box">
				    	<form class="form-horizontal" id="planEstablishDetailform" action="">
						    ...
						    <div class="form-group col-md-6 hidden DETAILED_LIST">
						        ...
						        <div>
						        	<input type="text" class="DETAILED_LIST form-control input-sm field-not-editable fixed-number text-right" id="mainMaterialAmountList" name="mainMaterialAmountList" data-parsley-type="number"  data-parsley-maxlength="16" value="${subBudget.mainMaterialAmountList }"/>
						       		<a href="javascript:;" class="btn btn-sm btn-default">元</a>
						        </div>
						    </div>
						     <div class="form-group col-md-6 hidden DETAILED_LIST">
						        ...
						        <div>
						        	<input type="text" class="DETAILED_LIST form-control input-sm field-not-editable fixed-number text-right" id="totalCost" name="totalCost" data-parsley-type="number" data-parsley-maxlength="16" value="${subBudget.totalCost }"/>
						       		<a href="javascript:;" class="btn btn-sm btn-default">元</a>
						        </div>
						    </div>
						    <div class="form-group col-md-6 hidden QUOTA">
						        ...
						        <div>
						        	<input type="text" class="QUOTA form-control input-sm field-not-editable fixed-number text-right" id="mainMaterialAmount" name="mainMaterialAmount" data-parsley-type="number" data-parsley-maxlength="16" value="${subBudget.mainMaterialAmount }"/>
						       		<a href="javascript:;" class="btn btn-sm btn-default">元</a>
						        </div>
						    </div>
						    <div class="form-group col-md-6 ">
						        ...
						        <div>
						        	<input type="text" class=" form-control input-sm field-not-editable fixed-number text-right" id="laborCost" name="laborCost" data-parsley-type="number" data-parsley-maxlength="16" value="${subBudget.laborCost }"/>
						       		<a href="javascript:;" class="btn btn-sm btn-default">元</a>
						        </div>
						    </div>
						    <div class="form-group col-md-6 ">
						        ...
						        <div>
						        	<input type="text" class=" form-control input-sm field-not-editable fixed-number text-right" id="auxiliaryMaterialAmount" name="auxiliaryMaterialAmount" data-parsley-type="number" data-parsley-maxlength="16" value="${subBudget.auxiliaryMaterialAmount }"/>
						       		<a href="javascript:;" class="btn btn-sm btn-default">元</a>
						        </div>
						    </div>
						    <div class="form-group col-md-6">
						        ...
						        <div>
						        	<input type="text" class="form-control input-sm field-not-editable fixed-number text-right" id="managementCost" name="managementCost" data-parsley-type="number" data-parsley-maxlength="16" value="${subBudget.managementCost }"/>
						       		<a href="javascript:;" class="btn btn-sm btn-default">元</a>
						        </div>
						    </div>
						    <div class="form-group col-md-6">
						        ...
						        <div>
						        	<input type="text" class="form-control input-sm field-not-editable fixed-number text-right" id="profit" name="profit" data-parsley-type="number" data-parsley-maxlength="16" value="${subBudget.profit }"/>
						        	<a href="javascript:;" class="btn btn-sm btn-default">元</a>
						        </div>
						    </div>
						    <div class="form-group col-md-6 hidden QUOTA">
						        ...
						        <div>
						        	<input type="text" class="QUOTA form-control input-sm field-not-editable fixed-number text-right" id="totalQuota" name="totalQuota" data-parsley-type="number" data-parsley-maxlength="16" value="${subBudget.totalQuota }"/>
						        	<a href="javascript:;" class="btn btn-sm btn-default">元</a>
						        </div>
						    </div>
						    ...
						    <div class="form-group col-md-12">
					            ...
					            <div>
					                <textarea class="form-control field-not-editable" name ="remark" id="remark" rows="2" data-parsley-maxlength="200">${subBudget.remark }</textarea>
					            </div>
				            </div>
						</form>
				    </div>
			...
			<div class="panel-body" id="drawing_audit_panel_box">
				<div class="toolBtn f-r m-b-15  editbtn">
			    	...
			    	<div class="clearboth form-box qualitiesAuditFormDiv">
			    		...
			    		<form class="form-horizontal" id="qualitiesAuditForm" action="budgetFirstAudit/auditSave">
...
<script>
    ...
    $.getScript('projectjs/subcontract/budget_first-audit-page.js?'+Math.random()).done(function () {
        qualitiesJudgement.init();
	});

    //放弃
    $(".cancelBtn").off("click").on("click",function(){
    	$("#ajax-content").cgetContent("budgetFirstAudit/main");
	});
