        ...
        <div class="col-sm-6 col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                   ...
                   <h4 class="panel-title">工程分包合同</h4>
                </div>
            ...
            <div class="panel panel-inverse" id="content">
			    ...
			    <div class="panel-body" id="contract_audit_panel_box">
			    	...
			    	<div class="clearboth form-box auditFormDiv">
			    		<form class="form-horizontal" id="contractAuditRightForm" action="scModifyAudit/auditSave">
...
<script>
    ...
    App.setPageTitle('合同修改审核 - 工程管理系统');
    ...
    $.getScript('projectjs/subcontract/sc-modify-audit-page.js').done(function () {
        auditHistory.init();
	});
    
    //放弃
    $(".auditCancelBtn").off("click").on("click",function(){
		$("#ajax-content").cgetContent("scModifyAudit/main");
	});
