...
<div class="infodetails">
	...
	<div class="clearboth form-box">
		<form class="form-horizontal" id="qualitiesAuditForm" action="">
 			...
 			<div class="form-group col-lg-12 col-md-12 col-sm-12">
	     		...
	     		<div> 
					<textarea class="form-control field-editable" name="" id="" rows="4" cols="" data-parsley-maxlength="200" >情况属实，工程量准确</textarea>
				</div>
			</div>
	    	...
	    	<div class="form-group col-lg-6 col-md-12 col-sm-6 " >
	        	...
	        	<div>
	           <input type="text" class=" form-control input-sm field-editable datepicker-default" id=""  name="" data-parsley-maxlength="100" value="2016-6-14">
	        	</div>
	    	</div>
		</form>
	</div>
