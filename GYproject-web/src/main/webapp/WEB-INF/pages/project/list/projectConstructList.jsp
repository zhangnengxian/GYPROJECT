            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
			        ...
			        <table id="projectConstructListTable" class="table table-striped table-bordered nowrap " width="100%">
	    	  	  	...
	    	  	  	<div class="hidden">
	    	  	  		<input class="to_cons" type="hidden" value="${to_construction}"/>
	    	  	  		<input class="during_cons" type="hidden" value="${during_construction}"/>
	    	  	  	</div>
                </div>
             </div>
        </div>
...
<script>
    ...
    $.getScript('projectjs/project/project-construct-list.js?'+Math.random()).done(function () {
