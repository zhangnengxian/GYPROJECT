        ...
        <div class="col-xs-12">
            <div class="panel panel-inverse no-equal-height">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">近一年各任务阶段工程数量统计</h4>
                </div>
        ...
        <div class="col-sm-6 col-xs-12">
            <div class="panel panel-inverse no-equal-height">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">工程项目安全质量检查项排名Top10</h4>
                </div>
                <div class="panel-body echart-panel">
			        <div class="mask-html text-center"><div><i class="fa fa-3x fa-spinner"></i><br><p class="text-ellipsis">加载中</p></div></div>
        ...
        <div class="col-sm-6 col-xs-12">
            <div class="panel panel-inverse no-equal-height">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">近一年施工部安全质量检查对比</h4>
                </div>
                <div class="panel-body echart-panel">
			        <div class="mask-html text-center"><div><i class="fa fa-3x fa-spinner"></i><br><p class="text-ellipsis">加载中</p></div></div>
...
<script>
    ...
    App.setPageTitle('工程统计图表 - 工程项目管理系统 ');
   	$.getScript('assets/plugins/echarts/build/dist/echarts.js').done(function(){
		$.getScript('projectjs/project/project-schedule-statistic.js').done(function () {
			projectScheduleStatistic.init();
		});
	});
</script>
<!-- ================== END PAGE LEVEL JS ================== -->