				...
				<div class="panel-body">
					...
					<form class="" id="projectConditionForm" action="/" method="POST">
						...
						<div class="form-group">
				      	...
				      	<div class="form-group">
				            <div>
				                <input type="text" class="form-control input-sm" placeholder="委托单号" name="ocoNo" value=""/>
				            </div>
				      	</div>
				      	<div class="form-group">
							<div>
...
<script>
   ...
   var showReport = function(){
   	...
   	src="<%=basePath%>/ReportServer?reportlet=statisticalquery/DesignSchedule.cpt&condition="+condition+"&staffName="+staffName;
