    ...
    <div class="clearboth form-box">
    	<form class="form-horizontal" id="surveyDetailform" data-parsley-validate="true" action="">
		   ...
		   <div class="form-group col-md-12">
			...
			<div class="form-group col-md-12">
		     	<label class="control-label" for="otherSuggestion">输配巡线建议</label>
		     	<div> 
		        	<textarea class="form-control  field-editable" name="otherSuggestion" id="otherSuggestion" rows="4" cols="" data-parsley-maxlength="500" ></textarea>
	        	</div>
		    </div>
		     <div class="form-group col-md-6 ">
				<label class="control-label" >建议填写日期</label>
				<div>
					<input type="text" class=" form-control input-sm field-not-editable datepicker-default" id="otherSugDate"  name="otherSugDate" value="" >
				</div>
			</div>
		</form>
