				    ...
				    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in btn-top active" id="default-tab-2">
                        	<input type="hidden" id="projId1" name="projId1"/>
		               		<table id="designChangeApplyTable" class="table table-striped table-bordered nowrap" width="100%">
				                <thead>
					                <tr>
					                    <th>Id</th>
					                    <th>申请编号</th>
...
<script>
    ...
    App.setPageTitle('变更申请 - 工程管理系统');
    
    $.getScript('projectjs/design/design-change-apply.js?v='+Math.random()).done(function () {
    	designChangeApplyTable.init();
	});
