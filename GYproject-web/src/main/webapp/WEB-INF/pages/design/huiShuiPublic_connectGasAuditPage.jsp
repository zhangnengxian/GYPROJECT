                    	...
                    	<form class="form-horizontal" id="connectGasAuditForm" action="">
						   ...
						   <div class="form-group col-md-6 col-sm-12">
						    ...
						    <div class="form-group col-md-12">
						     	...
						     	<div> 
						        	<textarea class="form-control field-editable " name="connectGasDes" id="connectGasDes" rows="2" cols="" data-parsley-maxlength="500" >${surveyInfo.connectGasDes}</textarea></div>
						    </div>
							...
							<div class="form-group col-md-12">
								...
								<div>
									<textarea class="form-control field-editable " name="custOpinon" id="custOpinon" rows="2" cols="" data-parsley-maxlength="500" >${surveyInfo.custOpinon}</textarea>
								</div>
							</div>
				
							<div class="form-group col-md-6 col-sm-12 allSign market">
								<label class="control-label signature-tool sign-require" for="market">市场部</label>
								<div>
									...
									<img class="market" alt="" src="${surveyInfo.market}" style="height: 30px">
							...
							<div class="form-group col-md-6 col-sm-12 allSign market">
								...
								<div>
									...
									<input type="hidden" class="signPost" id="customer_postType" name="customer_postType" value="" >
									<img class="duDeputy" alt="" src="${surveyInfo.customer}" style="height: 30px">
									<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
								</div>
							</div>
