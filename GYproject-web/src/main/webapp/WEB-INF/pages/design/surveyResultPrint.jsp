        ...
        <div class="col-sm-6 col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">现场踏勘打印列表</h4>
                </div>
...
<script>
    ...
    $.getScript('projectjs/design/survey-result-print.js?v='+Math.random()).done(function () {
    ...
    function queryCpt(json) {
        $.ajax({
            type:'post',
            url:'surveyResultPrint/queryCptUrl',
    ...
    function showReport(json) {
       var src = basePath+"/ReportServer?reportlet=design/"+json.cptUrl+"&surveyId="+json.surveyId+"&imgUrl="+$("#imgUrl").val();
