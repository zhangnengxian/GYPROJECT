...
<div class="infodetails">
	...
	<div class="clearboth form-box">
		...
		<form class="form-horizontal" id="designDispatchForm" data-parsley-validate="true" action="">
			...
			<div class="form-group col-md-6">
				<label class="control-label" for="projectRemark">受理人</label>
				<div>
					<input type="text" class="form-control input-sm field-not-editable"  id="accepter" name="accepter" value=""/>    
				</div>
			</div>
			<div class="form-group col-md-6">
				<label class="control-label" for="projectRemark">受理时间</label>
				<div>
	...
	<div>
    <h4 class="m-t-20"><strong>踏勘员</strong></h4>
    </div>
...
<script>
    ...
    var menuId='110207';//踏勘派工
    
    //查右侧工程详述
    //trSData.t.cgetDetail('designDispatchForm','designDispatch/viewDispatchResult','',detailBack);
    trSData.t&&trSData.t.cgetDetail('designDispatchForm','designDispatchSecondary/viewDispatchResult','',detailBack);
    	...
    	if($("#designDispatchForm").parsley().isValid()){
    		//if(radioVal=="1"){
       		    ...
       		    if(len>0){
       		    	...
       		    	$("#surveyer").val(surveyer);    //选择的踏勘员
       		    	var surveyerId=json[0].staffId;
       		        $("body").cgetPopup({
	                 	    title: "提示信息",
	                    	...
	                    	accept: function(){
	                 		...
	                 		console.info(data);
	           	        	$.ajax({
	           	                type: 'POST',
	           	                url: 'designDispatchSecondary/updateProject',
