    ...
    <div class="clearboth form-box">
    	<form class="form-horizontal" id="surveyDetailform" data-parsley-validate="true" action="">
			...
			<div class="form-group col-md-12">
		     	...
		     	<div> 
		        	<textarea class="form-control field-editable surveyContent allText market builder" name="surveyDes" id="surveyDes" rows="2" cols="" data-parsley-maxlength="500" ></textarea></div>
		    </div>
		    ...
		    <div class="form-group col-md-12">
		     	...
		     	<div> 
		        	<textarea class="form-control field-editable  allText market builder" onchange="getCurrentFillDate(this.id)" name="connectGasDes" id="connectGasDes" rows="2" cols="" data-parsley-maxlength="500" ></textarea></div>
		    </div>
...
<script>
	...
	//踏勘员可以推送
	if($("#post").val()!=""){
		if($("#post").val().indexOf($("#marketPost").val())>=0 || $("#post").val().indexOf($("#surveyBuilderPost").val())>=0){
