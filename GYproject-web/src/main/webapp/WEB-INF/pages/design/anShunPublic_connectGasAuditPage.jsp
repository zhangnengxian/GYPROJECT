            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" >
                    ...
                    <input type="hidden" name="stepId" value="${stepId}"/>
                    	<form class="form-horizontal" id="connectGasAuditForm" action="">
						   ...
						   <div class="form-group col-md-6 col-sm-12">
						    ...
						    <div class="form-group col-md-12">
						     	...
						     	<div> 
						        	<textarea class="form-control field-editable designContent" name="technicalSuggestion" id="technicalSuggestion" rows="2" cols="" data-parsley-maxlength="500" >${surveyInfo.technicalSuggestion} </textarea>
								</div>
						    </div>
							<div class="form-group col-md-12">
								<label class="control-label " for="technicalSuggestion">用户意见</label>
								<div>
									<textarea class="form-control field-editable designContent" name="custOpinon" id="custOpinon" rows="2" cols="" data-parsley-maxlength="500" >${surveyInfo.custOpinon}</textarea>
								</div>
							</div>
						...
						<%-- <div class="form-group col-md-6 col-sm-12 allSign designer">
							<label class="control-label signature-tool sign-require" for="market">市场部人员</label>
							<div>
								<a href="javascript:;" class="btn btn-sm btn-white" id="signBtn_3"><i class="fa fa-pencil"></i></a>
