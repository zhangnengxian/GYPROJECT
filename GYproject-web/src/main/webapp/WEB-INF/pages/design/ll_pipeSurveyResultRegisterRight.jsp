    ...
    <div class="clearboth form-box">
    	<form class="form-horizontal" id="surveyDetailform" data-parsley-validate="true" action="">
		    ...
		    <div class="form-group col-md-6 hidden" >
		        <label class="control-label" for="surveyBuilder">现场代表</label>
		        <div>
		           <input type="text" class=" form-control input-sm field-not-editable" id="surveyBuilder"  name="surveyBuilder" data-parsley-maxlength="20" value="">
		        </div>
		    </div>
		     ...
		     <div class="form-group col-md-6 ">
		        ...
		        <div>
		           <input type="text" class=" form-control input-sm field-editable" id="designer" name="designer" data-parsley-required="true">
		    ...
		    <div class="form-group col-md-6 ">
		        ...
		        <div>
		           <input type="text" class=" form-control input-sm field-not-editable datepicker-default surveyContent" id="surveyDate"  name="surveyDate" data-parsley-required="true" value="" >
		        </div>
		    </div>
		    <!--  现场情况 -->
...
function surveyBack(data){
	...
	if($("#custName").val()==""){
	 ...
	 //工程部立项的踏勘现场代表就是踏勘员
/* 	 $("#surveyBuilder").val($("#surveyer").val());
	 $("#surveyBuilderId").val($("#surveyerId").val());
