    ...
    <div class="clearboth form-box">
    	<form class="form-horizontal" id="surveyDetailform" data-parsley-validate="true" action="">
			...
			<div class="form-group col-md-12">
		     	...
		     	<div> 
		        	<textarea class="form-control field-editable surveyContent allText market builder processTechnician" name="surveyDes" id="surveyDes" rows="2" cols="" data-parsley-maxlength="500" ></textarea></div>
		    </div>
            
			<div class="form-group col-md-6 col-sm-12">
				<label class="control-label" for="">燃气主管</label>
				<div>
					<label>
						<input type="radio" class="field-editable surveyContent" name="isElectronicData" value="1" checked/>有
					</label>
					<label>
						<input type="radio" class="field-editable surveyContent" name="isElectronicData" value="0" />无
					</label>
				</div>
			</div>
			<div class="form-group col-md-6 col-sm-12">
				<label class="control-label" for="">有无意向</label>
				<div>
					<label>
						<input type="radio" class="field-editable surveyContent" name="isNewBuild" value="1" checked/>有
					</label>
					<label>
						<input type="radio" class="field-editable surveyContent" name="isNewBuild" value="0" />无
					</label>
				</div>
			</div>
			<div class="form-group col-md-12">
		    ...
		    <div class="form-group col-md-12">
		     	<label class="control-label " for="connectGasDes">业务部门意见</label>
		     	<div> 
		        	<textarea class="form-control field-editable  allText market builder processTechnician" onchange="getCurrentFillDate(this.id)" name="connectGasDes" id="connectGasDes" rows="2" cols="" data-parsley-maxlength="500" ></textarea></div>
		    </div>

			<div class="form-group col-md-6 col-sm-12 allSign market builder processTechnician">
				<label class="control-label signature-tool sign-require" for="market">业务负责人</label>
				<div>
			...
			<div class="form-group col-md-6 col-sm-12">
				<label class="control-label" >业务负责人填写日期</label>
				<div>
...
<script>
  ...
  //移动端点击上传
	...
	var diffFunc =function(){
		if($("#post").val().indexOf($("#designerPost").val())>=0){
		...
		}else if($("#post").val().indexOf($("#marketPost").val())>=0 || $("#post").val().indexOf($("#surveyPost").val())>=0){
			...
			$(".surveyContent,#projName,#projAddr,.market").removeClass("field-not-editable");
			$(".surveyContent,#projName,#projAddr,.market").addClass("field-editable");
			...
			$(".market").find(".sign-data-input").toggleSign(true);
