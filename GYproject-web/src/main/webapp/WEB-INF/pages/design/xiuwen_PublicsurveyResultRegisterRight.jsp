    ...
    <div class="clearboth form-box">
    	<form class="form-horizontal" id="surveyDetailform" data-parsley-validate="true" action="">
		    ...
		    <div class="form-group col-md-12  ">
		        ...
		        <div>
		            <input type="text" class="form-control input-sm field-not-editable surveyContent"  id="projName" name="projName" data-parsley-maxlength="200" value="" data-parsley-required="true"/>
		        </div>
		    </div>
		    <div class="form-group col-md-12  ">
		        <label class="control-label" for="projAddr">工程地点</label>
		        <div>
		            <input type="text" class="form-control input-sm field-not-editable surveyContent"  id="projAddr" name="projAddr" value="" data-parsley-required="true"/>
		        </div>
		    </div>
		    <div class="form-group col-md-12">
		    ...
		    <div class="form-group col-md-12 noUser">
		        ...
		        <div>
		            <input type="text" class="form-control input-sm field-not-editable surveyContent"  id="custName" name="custName" value=""/>
		        </div>
		    </div>
		...
		<!-- 	<div class="form-group col-md-6 ">
			...
			<div class="form-group col-md-12">
		     ...
		     <input type="hidden"  name="installContent" id="installContent" />
              <div class="form-group col-md-12 col-sm-12 ">
		        <label class="control-label" for="">报装内容</label>
		    	<div>
		    		
			        	<label><input type="checkbox"  name="installContentCheck" class="field-editable surveyContent"  value="0"/>大锅灶</label>
			        	<label><input type="checkbox"  name="installContentCheck" class="field-editable surveyContent"  value="1"/>壁挂炉</label>
			        	<label><input type="checkbox"  name="installContentCheck" class="field-editable surveyContent"  value="2"/>锅炉</label>
			        	<label><input type="checkbox"  name="installContentCheck" class="field-editable surveyContent"  value="4"/>生产设备</label>
			        	<label><input type="checkbox"  name="installContentCheck" class="field-editable surveyContent"  value="5"/>其他设备</label>
			        	<label><input type="checkbox"  name="installContentCheck" class="field-editable surveyContent"  value="6"/>预留管</label>
		    ...
		    <div class="form-group col-md-6 col-sm-12">
        	 ...
        	 <div class="form-group col-md-6 clearboth">
                 ...
                 <div>
                    <input type="text" class=" form-control input-sm field-editable surveyContent " id="customerSituation"  name="customerSituation" data-parsley-maxlength="20" value="" >
                 </div>
             </div>
             <div class="form-group col-md-6 ">
			...
			<div class="form-group col-md-6 col-sm-12">
				...
				<div>
					<label>
						<input type="radio" class="field-editable surveyContent" name="isElectronicData" value="1" checked/>有
					</label>
					<label>
             ...
             <div class="form-group col-md-6 col-sm-12">
	             ...
	             <div>
	                 <label>
	                     <input type="radio" class="field-editable surveyContent" name="isNewBuild" value="1" checked/>是
	                 </label>
	                 <label>
			...
			<div class="form-group col-md-6 col-sm-12">
				<label class="control-label" for="approachCondition">主体工程完工</label>
				<div>
					<label>
						<input type="radio" class="field-editable surveyContent" name="approachCondition" value="1" checked/>已完工
					</label>
					<label>
			...
			<div class="form-group col-md-6 col-sm-12">
                 ...
                 <div>
                     <label>
                         <input type="radio" class="field-editable surveyContent" name="installNums" value="1" checked/>有
                     </label>
                     <label>
             ...
             <div class="form-group col-md-6 col-sm-12">
                 <label class="control-label" for="installaRequirements">安装要求</label>
                 <div>
                     <label>
                         <input type="radio" class="field-editable surveyContent" name="installaRequirements" value="1" checked/>已达到
                     </label>
                     <label>
			...
			<div class="form-group col-md-6 col-sm-12 clearboth">
                 <label class="control-label" for="municipalRoad">是否市政破路</label>
                 <div>
                     <label>
                         <input type="radio" class="field-editable surveyContent" name="municipalRoad" value="1" />是
                     </label>
                     <label>
                         <input type="radio" class="field-editable surveyContent" name="municipalRoad" value="0" checked/>否
                     </label>
                 </div>
             </div>
             <div class="form-group col-md-6">
				...
				<div>
					<input type="text" class="form-control input-sm field-editable surveyContent"  id="trunkLength" name="trunkLength" data-parsley-maxlength="20"  value=""/>
				</div>
			</div>
             ...
             <div class="form-group col-md-6 col-sm-12">
                 ...
                 <div>
                     ...
                     <label>
                         <input type="radio" class="field-editable surveyContent" name="isTooLong" value="0" checked/>否
                     </label>
                 </div>
             </div>
             <div class="form-group col-md-6">
				...
				<div>
					<input type="text" class="form-control input-sm field-editable surveyContent"  id="exceedLong" name="exceedLong" data-parsley-maxlength="20"  value=""/>
				</div>
			</div>
			<div class="form-group col-md-6 col-sm-12">
                 ...
                 <div>
                     ...
                     <label>
                         <input type="radio" class="field-editable surveyContent" name="highOverhead" value="0" checked/>否
                     </label>
                 </div>
             </div>
             <div class="form-group col-md-6">
				...
				<div>
					<input type="text" class="form-control input-sm field-editable surveyContent"  id="highOverheadMeters" name="highOverheadMeters" data-parsley-maxlength="20"  value=""/>
				</div>
			</div>
			...
			<div class="form-group col-md-6">
				...
				<div>
					<input type="text" class="form-control input-sm field-editable surveyContent"  id="conTimeLimit" name="conTimeLimit" data-parsley-maxlength="20"  value=""/>
				</div>
			</div>
		    ...
		    <div class="form-group col-md-12">
		     	...
		     	<div> 
		        	<textarea class="form-control field-editable surveyContent" name="connectGasDes" id="connectGasDes" rows="2" cols="" data-parsley-maxlength="500" ></textarea></div>
		    </div>
		    <div class="form-group col-md-12">
		     	<label class="control-label " for="technicalSuggestion">设计人员意见</label>
		     	<div> 
		        	<textarea class="form-control field-editable designContent" name="technicalSuggestion" id="technicalSuggestion" rows="2" cols="" data-parsley-maxlength="500" ></textarea></div>
		    </div>
			<div class="form-group col-md-12">
				<label class="control-label " for="technicalSuggestion">用户意见</label>
				<div>
					<textarea class="form-control field-editable " name="custOpinon" id="custOpinon" rows="2" cols="" data-parsley-maxlength="500" ></textarea>
				</div>
			</div>
			...
			<div class="form-group col-md-6 col-sm-12 allSign market">
				<label class="control-label signature-tool sign-require" for="engineering">踏勘员</label>
				<div>
			...
			<div class="form-group col-md-6 col-sm-12 allSign market">
				<label class="control-label signature-tool sign-require" for="customer">用&nbsp;&nbsp;户</label>
				<div>
					<a href="javascript:;" class="btn btn-sm btn-white" id="signBtn_3"><i class="fa fa-pencil"></i></a>
					<input type="hidden" class="sign-data-input" id="customer" name="customer" value="">
					<input type="hidden" class="signPost" id="customer_postType" name="customer_postType" value="${customer }" >
					<img class="duDeputy" alt="" src="" style="height: 30px">
					<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
				</div>
			</div>
...
<script>
    ...
    console.info("installContent---"+data.installContent);	
    var checkBox = data.installContent;
    ...
    $(".entBtn").off("click").on("click",function(){
        if ($("#post").val().indexOf($("#designerPost").val())!=-1){
            $("#technicalSuggestion").attr("required",true)
        }

		$("#connectGasDes").removeAttr("data-parsley-required",false);
