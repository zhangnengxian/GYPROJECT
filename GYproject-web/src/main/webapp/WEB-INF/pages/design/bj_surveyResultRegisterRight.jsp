    ...
    <div class="clearboth form-box">
    	<form class="form-horizontal" id="surveyDetailform" data-parsley-validate="true" action="">
		    ...
		    <div class="form-group col-md-12  ">
		        ...
		        <div>
		            <input type="text" class="form-control input-sm field-editable"  id="projName" name="projName" data-parsley-maxlength="200" value="" data-parsley-required="true"/>
		        </div>
		    </div>
		    <div class="form-group col-md-12  ">
		        <label class="control-label" for="projAddr">工程地点</label>
		        <div>
		            <input type="text" class="form-control input-sm field-editable"  id="projAddr" name="projAddr" value="" data-parsley-required="true"/>
		        </div>
		    </div>
		    <div class="form-group col-md-12">
		    ...
		    <div class="form-group col-md-6 col-sm-12 mobileDiv hidden">
				...
				<div>
					<input type="text" class="form-control input-sm field-not-editable" value="" id="projLongitude" name="projLongitude" />
				</div>
			</div>
			<div class="form-group col-md-6 col-sm-12 mobileDiv hidden">
				<label class="control-label">纬度</label>
				<div>
					<input type="text" class="form-control input-sm field-not-editable" value="" id="projLatitude" name="projLatitude" />
				</div>
			</div>
			...
			<div class="form-group col-md-6 ">
                 ...
                 <div>
                    <input type="text" class=" form-control input-sm field-editable datepicker-default " id="surveyDate"  name="surveyDate" readonly="readonly" data-parsley-required="true" value="" >
                 </div>
             </div>
			<div class="form-group col-md-12">
		    ...
		    <div class="form-group col-md-6 ">
		        <label class="control-label" for="gasSourceUse">庭院管号</label>
		        <div>
		            <input type="text" class="form-control input-sm field-editable surveyContent"   id="gasSourceUse" name="gasSourceUse" data-parsley-maxlength="50"  value=""/>
		        </div>
		    </div>
			<div class="form-group col-md-6 col-sm-12 clearboth">
				<label class="control-label" for="isNewBuild">已安装情况</label>
				<div>
					<label>
						<input type="radio" class="field-editable surveyContent" name="isNewBuild" value="1" checked/>庭院
					</label>
					<label>
						<input type="radio" class="field-editable surveyContent" name="isNewBuild" value="2" />户内
					</label>
				</div>
			</div>
			<div class="form-group col-md-6 col-sm-12">
				<label class="control-label" for="isElectronicData">已交资料</label>
				<div>
					<label>
			 ...
			 <div class="form-group col-md-6 clearboth">
		        <label class="control-label" for="customerSituation">设计情况</label>
		        <div>
		            <input type="text" class="form-control input-sm field-editable "  id="customerSituation" name="customerSituation" data-parsley-maxlength="50"  value=""/>
		        </div>
		    </div>
		    <div class="form-group col-md-6 ">
		        <label class="control-label" for="withGasFrequency">估算费用</label>
		        <div>
		            <input type="text" class="form-control input-sm field-editable"  id="highOverheadMeters" name="highOverheadMeters" data-parsley-maxlength="50"  value=""/>
		        </div>
		    </div>
		    <div class="form-group col-md-6 clearboth">
		        <label class="control-label" for="exceedLong">庭院管长</label>
		        <div>
		     ...
		     <div class="form-group col-md-6 ">
		        <label class="control-label" for="withGasFrequency">估算费用</label>
		        <div>
		            <input type="text" class="form-control input-sm field-editable surveyContent"  id="highOverhead" name="highOverhead" data-parsley-maxlength="50"  value=""/>
		        </div>
		    </div>
		    <div class="form-group col-md-6 ">
		        <label class="control-label" for="exceedLong">户内超长</label>
		        <div>
		            <input type="text" class="form-control input-sm field-editable surveyContent"  id="exceedLong" name="exceedLong" data-parsley-maxlength="50"  value=""/>
		        </div>
		    </div>
			<div class="form-group col-md-12">
				<label class="control-label " for="technicalSuggestion">设计技术建议</label>
				<div>
					<textarea class="form-control field-editable " onchange="getCurrentFillDate(this.id)" name="technicalSuggestion" id="technicalSuggestion" rows="2" cols="" data-parsley-maxlength="500"></textarea></div>
			</div>
			<div class="form-group col-md-6 col-sm-12">
		    ...
		    <div class="form-group col-md-12">
		     	<label class="control-label " for="connectGasDes">踏勘情况说明</label>
		     	<div> 
		        	<textarea class="form-control field-editable surveyContent" onchange="getCurrentFillDate(this.id)" name="connectGasDes" id="connectGasDes" rows="2" cols="" data-parsley-maxlength="500" ></textarea></div>
		    </div>

			<div class="form-group col-md-6 col-sm-12 allSign market builder">
				<label class="control-label signature-tool sign-require" for="market">踏勘员</label>
				<div>
			...
			<div class="form-group col-md-6 col-sm-12">
				<label class="control-label" >踏勘说明填写日期</label>
				<div>
...
<script>
    ...
    $(".entBtn").off("click").on("click",function(){
		...
		if($('#post').val().indexOf($('#designerPost').val()) != -1){//如果有设计员职务，设计员意见必填
			...
			$("#technicalSuggestion").removeAttr("data-parsley-required");
		}
  ...
  //移动端点击上传
	...
	var diffFunc =function(){
		if($("#post").val().indexOf($("#designerPost").val())>=0){
			...
			$(".surveyContent,#projName,#projAddr").removeClass("field-not-editable");
			$(".surveyContent,#projName,#projAddr").addClass("field-editable");
		...
		}else if($("#post").val().indexOf($("#surveyBuilderPost").val())>=0){
			//现场代表 市场、设计、用户不可填写
			console.info("现场代表--");
			$("#gasContent").removeClass("field-not-editable")
			$("#gasContent").addClass("field-editable");
			
			$(".surveyContent,#technicalSuggestion,#custOpinon").removeClass("field-editable");
			$(".surveyContent,#technicalSuggestion,#custOpinon").addClass("field-not-editable");
		}else{
			$("#technicalSuggestion").removeClass("field-editable");
			$("#technicalSuggestion").addClass("field-not-editable");
    ...
    function getCurrentFillDate(param) {
        if(param=='technicalSuggestion'){//技术建议填写日期
            $('#techSugDate').val(getCurrentDate());
		}else if(param=='connectGasDes'){//业务负责人填写日期
           $('#surveyDesDate').val(getCurrentDate());
		}
