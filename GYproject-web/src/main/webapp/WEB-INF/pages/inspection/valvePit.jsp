               		...
               		<div class="tab-content">
	                   	...
	                   	<div class="tab-pane fade  btn-top" id="default-tab-3">
	                   		<div class="toolBtn f-r p-b-10">
			                    ...
			                    <a href="javascript:;" class="btn btn-warn btn-sm m-l-5 deletebtn">删除</a>
						    </div>
						    <div class="clearboth form-box">
							        ...
							        <div class="form-group col-md-6 col-sm-12">
							            ...
							            <div>
							                <select class="form-control input-sm field-editable" id="dpCheckItem" data-parsley-required="true"  name="dpCheckItem"  >
								                <option value="">基础尺寸及外观检查</option>
								                <option value="">支架尺寸、牢固性</option>
								                <option value="">安装位置</option>
								                <option value="">进法兰平度及连接</option>
								                <option value="">安装水平、表面损伤</option>
								                <option value="">箱、柜内表等安装</option>
								                <option value="">气密性试验、防腐检查</option>
								              </select>
							            </div>
							        </div>
								    <div class="form-group col-md-6 col-sm-12">
							            <label class="control-label" for="dpMethod">要求</label>
							            <div>
							                <select class="form-control input-sm field-editable" id="dpMethod" data-parsley-required="true"  name="dpMethod"  >
								                <option value="">长X宽X高符合图纸</option>
								                <option value="">符合图纸及规范要求</option>
								                <option value="">符合图纸规范</option>
								                <option value="">要求水平连接、牢靠</option>
								                <option value="">用水平尺检查</option>
								                <option value="">要求完整齐全</option>
								                <option value="">无渗漏，防腐合格</option>
								              </select>
							            </div>
							        </div>
							        <div class="form-group col-md-6 col-sm-12">
...
<script>
    ...
    App.setPageTitle('箱柜安装 - 工程项目管理系统 ');
    ...
    var showReport1 = function(){
    	...
    	src = cptPath+"/ReportServer?reportlet=valvePit/valvePit.cpt&projName=" + projName+"&suName="+suName+"&constructionUnit="+constructionUnit+"&selfCheckDate="+selfCheckDate;
    ...
    showReport2 = function(){
    	...
    	src = cptPath+"/ReportServer?reportlet=valvePit/valvePit1.cpt&projName=" + projName+"&pcId="+pcId+"&suName="+suName+"&constructionUnit="+constructionUnit+"&inspectionDate="+inspectionDate+"&dpPipeSize="+dpPipeSize+"&dpNum="+dpNum+"&dpReplayNum="+dpReplayNum+"&dpKv="+dpKv;
    ...
    var showReport3 = function(){
    	...
    	var src = cptPath+"/ReportServer?reportlet=valvePit/valvePit.cpt&projName="+projName+"&suName="+suName+"&constructionUnit="+constructionUnit;
    	src = src+"&pcId="+pcId+"&imgUrl="+$(".imgUrl").val();
    	$("#mainFrm").attr("src",src); 
    }
  	//签字加载方式
   ...
   //打印预览窗口缩放调整
    ...
    $.getScript('projectjs/inspection/valve-pit.js').done(function () {
    	valvePit.init();
	});
