						    ...
						    <div class="clearboth form-box">
								...
								<form class="form-horizontal" id="signForm"  enctype="multipart/form-data"  data-parsley-validate="true" action="${actionName }/saveSignFile">
									...
									<div class="form-group col-sm-12 drawDiv">
										<label class="control-label" for="drawName">焊口单线图</label>
										<div>
									...
									<div class="form-group col-md-6 col-sm-12">
										...
										<div>
											<input type="text" class="form-control input-sm datepicker-default field-editable addClear allText welder construction"  id="inspectionDate" name="inspectionDate" data-parsley-required="true" />
										</div>
									</div>
									...
									<div class="form-group  col-sm-12">
					                    ...
					                    <div> 
				                        	<textarea class="form-control field-editable addClear allText welder construction" name="inspectionResult" id="inspectionResult" rows="3" cols="" data-parsley-maxlength="200" ></textarea>
					                    </div>
					  			    </div>
					  			    
									<!-- <div class="form-group col-sm-12">
											<label class="control-label proj_change" for="">示意图</label>
											<div>
											<div class="hidden hasVal"> 
							         			<input type="text" class="form-control input-sm field-not-editable" id="drawName" name="drawName"/>
							         			<a class="btn btn-sm btn-primary searchButton " href="" target="_blank">查看</a>
						    ...
						    <div class="clearboth form-box">
						    	<!-- 完成标记 -->
		                   		...
		                   		<form class="form-horizontal" id="auditForm" data-parsley-validate="true" action="">
		                   			<input type="hidden" name="pwrId" id="pwrId" class="addClear"/>
		                   			...
		                   			<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="pwrNo">焊口记录及编号</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText welder construction" id="pwrNo"   name="pwrNo"  data-parsley-required="true" data-parsley-maxlength="50"/>
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="pwSpec">规格</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText welder construction" id="pwSpec"   name="pwSpec"   data-parsley-maxlength="50"/>
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="welderName">焊工姓名</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText welder construction" id="welderName"   name="welderName"   data-parsley-maxlength="100"/>
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="welderNo">焊工证号</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText welder construction" id="welderNo"   name="welderNo"   data-parsley-maxlength="50"/>
							            </div>
									</div>
...
<script>
    ...
    App.setPageTitle('焊口记录- 工程项目管理系统 ');
   ...
   if($(".iframe-report").length > 0){
    ...
    $.getScript('projectjs/inspection/inspection-common.js?'+Math.random()).done(function() {
    	$.getScript('projectjs/inspection/pipe-weld-record.js?'+Math.random()).done(function () {
    		pipeWeldRecord.init();
 	   });
    });
    //图片查看功能
    ...
    var showReport = function(){
        ...
        //cpt路径及参数
        var ur = "pipeWeldRecord.cpt";
        if(isUpdate()){
            ur = "pipeWeldRecordNew.cpt";
        }
        var src=cptPath+"/ReportServer?reportlet=inspection/"+ur+"&projName="+projName+"&inspectionDate="+inspectionDate;
    ...
    $("#recordImagesList .uploadBtn").off("click").on("click",function(){
		...
		if(_inApk && $(".attach-images-list").find(".new-image").length){
		    ...
		    //navigator.notification.alert(files);
		     if (!projNo && $("#pwrId1").length && !$("#pwrId1").val()) {
