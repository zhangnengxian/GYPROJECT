               	...
               	<div class="panel-body" id="">
               		<div class="tab-content">
               			<div class="tab-pane fade active in btn-top" id="default-tab-1" >
	                		...
	                		<table data-attach-table="all" class="table table-hover table-striped table-bordered nowrap" id="lowVoltageInstallationTable" width="100%">
	                			<thead>
		                			<tr>
		                				<th></th>
		                				<th>报验日期</th>
               			...
               			<div class="tab-pane fade in btn-top" id="default-tab-2">
						    ...
						    <div class="clearboth form-box">
						    	...
						    	<form class="form-horizontal" id="lowVoltageInstallationForm" data-parsley-validate="true" action="lowVoltageInstallation/saveLowVoltageInstallation">
               			...
               			<div class="tab-pane fade in btn-top" id="default-tab-3">
						    ...
						    <form id="threadingPipeAuditForm">
	               				<table id="lowVoltageInstallationAuditTable" class="table table-striped table-bordered nowrap " width="100%">
		                            <thead>
		                                <tr>
		                                	<th></th>
		                                	<th></th>
						    ...
						    <form id="basicThreadingPipeItemForm">
		                       	<table id="basicLowVoltageInstallationTable" class="table table-striped table-bordered nowrap " width="100%">
		                            <thead>
		                                <tr>
		                                	<th></th>
		                                	<th></th>
...
<script>
    ...
    $("#lowVoltageInstallationForm").toggleEditState().styleFit();
    ...
    var showReport1 = function(){
    	...
    	var json=trSData.lowVoltageInstallationTable.json;
    	if(json){
    	...
    	src = cptPath+"/ReportServer?reportlet=lowVoltageInstallation/lowVoltageInstallation.cpt&projName=" + projName+"&suName="+suName+"&constructionUnit="+constructionUnit+"&selfCheckDate="+selfCheckDate;
    ...
    var showReport2 = function(){
    	...
    	var src = cptPath+"/ReportServer?reportlet=lowVoltageInstallation/lowVoltageInstallation1.cpt&projName="+projName+"&pcId="+pcId+"&suName="+suName+"&constructionUnit="+constructionUnit+"&selfCheckDate="+selfCheckDate+"&checkDate="+checkDate;
    ...
    $.getScript('projectjs/inspection/low-voltage-installation.js').done(function () {
    	lowVoltageInstallation.init();
	});
    ...
    $('.saveBtn').off().on("click",function(){
    	$('#lowVoltageInstallationForm').cformSave('lowVoltageInstallationTable',saveLwVoltageInstallationBack,false);
    })
    var saveLwVoltageInstallationBack=function(data){
		$('.editBtn').addClass("hidden");
    ...
    $(".savebtn").on("click",function(){
    	if($('#pcIdNew').val()!==''){
    		...
    		dataObj.firstList = [],
    		dataObj.secondList = [];
    		var firstJson=$("#lowVoltageInstallationAuditTable").DataTable().rows().data();
        	...
        	console.info('1-----')
        	var secondJson=$("#basicLowVoltageInstallationTable").DataTable().rows().data();
    		...
    		if(response){
    	    	response.abort();
      		  	...
      		  	var response = $.ajax({
    			url: "lowVoltageInstallation/saveLowVoltageInstallationRecord",
      	          	type: "POST",
      	          	timeout : 5000,
