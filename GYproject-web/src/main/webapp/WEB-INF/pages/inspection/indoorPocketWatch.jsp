    ...
    <div class="row">
               		...
               		<div class="tab-content">
	                   	...
	                   	<div class="tab-pane fade btn-top" id="default-tab-2">
						    ...
						    <div class="clearboth form-box">
								...
								<form class="form-horizontal" id="signForm" data-parsley-validate="true" action="${actionName }/saveSignFile">
									...
									<input type="hidden" id="suName" name="suName" >
									...
									<div class="form-group  col-sm-6">
										<!-- 新加字段 -->
										<label class="control-label" for="protocalNo">协议编号</label>
										<div>
											<input type="text" class="form-control field-editable input-sm addClear allText construction"  id="protocalNo" name="protocalNo"  value="" data-parsley-maxlength="50"/>
										</div>
									</div>
									<div class="form-group  col-sm-6">
										<!-- 新加字段 -->
										<label class="control-label" for="ipwPatchCode">片区号</label>
										<div>
											<input type="text" class="form-control field-editable input-sm addClear allText construction"  id="ipwPatchCode" name="ipwPatchCode" data-parsley-maxlength="50" />
										</div>
									</div>
									<div class="form-group  col-sm-6">
										<!-- 新加字段 -->
										<label class="control-label" for="curtyardNo">庭院管号</label>
										<div>
											<input type="text" class="form-control field-editable input-sm addClear allText construction" id="curtyardNo" name="curtyardNo"  data-parsley-maxlength="50"/>
										</div>
									</div>
									<div class="form-group  col-sm-6">
										<!-- 新加字段 -->
										<label class="control-label" for="drawBuildingNo">图纸楼号</label>
										<div>
											<input type="text" class="form-control field-editable input-sm addClear allText construction" id="drawBuildingNo" name="drawBuildingNo"  data-parsley-maxlength="50"/>
										</div>
									</div>
									<div class="form-group  col-sm-6">
										<!-- 新加字段 -->
										<label class="control-label" for="installAddr">安装地址</label>
										<div>
											<input type="text" class="form-control field-editable input-sm addClear allText construction" id="installAddr" name="installAddr" data-parsley-maxlength="100" />
										</div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<!-- 新加字段 -->
										<label class="control-label">挂表日期</label>
										<div>
											<input type="text" class="form-control input-sm datepicker-default field-editable allText construction" value="" id="ipwDate" name="ipwDate"  />
										</div>
									</div>
									...
									<div class="form-group col-md-6 col-sm-12">
										...
										<div>
											<input type="text" class="form-control input-sm datepicker-default field-editable addClear allText construction"  id="inspectionDate" name="inspectionDate"  data-parsley-required="true"  />
										</div>
									</div>
									...
									<div class="form-group col-sm-12">
										<label class="control-label" for="">用户单位</label>
										<div>
											<input type="text" class="form-control field-not-editable input-sm" id="custName" name="custName"/>
										</div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label signature-tool sign-require sign-all" for="">业主代表</label>
										<div>
											<a href="javascript:;" class="btn btn-sm btn-white" id="signBtn_2"><i class="fa fa-pencil"></i></a>
											<input type="hidden" class="sign-data-input" id="businessOwner" name="businessOwner" value="">
											<input type="hidden" class="signPost"  id="businessOwner_post" name="businessOwner_post" value="">
											<img class="businessOwner" alt="" src="" style="height: 30px">
											<span class="clear-sign"><i class="fa ion-close-circled"></i></span>
										</div>
						    		</div>
								    <div class="form-group col-md-6 col-sm-12 hidden selectSignDate">
										<label class="control-label">签字日期</label>
										<div>
											<input type="text" class="form-control input-sm datepicker-default field-editable addClear" value="" id="boSignDate" name="boSignDate"  />
										</div>
									</div>
									...
									<div class="form-group col-md-6 col-sm-12 allSign cuPm construction">
										...
										<div>
											...
											<input type="hidden" class="signPost"  id="constructionPrincipal_postType" name="constructionPrincipal_postType" value="${cuPm}">
								    ...
								    <div class="form-group col-md-6 col-sm-12 hidden selectSignDate">
										<label class="control-label">签字日期</label>
										<div>
											<input type="text" class="form-control input-sm datepicker-default field-editable addClear allText cuPm" value="" id="cupSignDate" name="cupSignDate"  />
										</div>
									</div>
								</form>
								<!-- 照片 -->
	                   	...
	                   	<div class="tab-pane fade  btn-top" id="default-tab-3">
						    ...
						    <div class="clearboth form-box">
						    	...
						    	<input type="hidden" id="flag1"  class="addClear">
		                   		...
		                   		<input type="hidden"  name="ipwId" id="ipwId" class="addClear" />
		                   		<input type="hidden" id="version" name="version" class="addClear"/>
		                   		...
		                   		<input type="hidden" id="isFinishSign" name="isFinishSign" class="addClear">
		                   			<div class="form-group col-md-6 col-sm-12">
		                   				<!-- 新加字段 -->
										<label class="control-label" for="">立管编号</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText construction" id="riserNo"   name="riserNo"  data-parsley-required="true" data-parsley-maxlength="30"/>
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<!-- 新加字段 -->
										...
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText construction" id="installNum"   name="installNum"  data-parsley-required="true" data-parsley-maxlength="30"/>
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<!-- 新加字段 -->
						            	<label class="control-label" for="">楼层安装</label>
							            <div class="input-group">
								            <input type="text" class="form-control input-sm field-editable addClear allText construction"  id="floorStart" data-parsley-required="true" name="floorStart" value="1" data-parsley-maxlength="30">
								            <span class="input-group-addon">至</span> 
								            <input type="text" class="form-control input-sm field-editable addClear allText construction"  id="floorEnd"  data-parsley-required="true" name="floorEnd" value="1" data-parsley-maxlength="30">
							            </div>
							        </div>
        ...
        <div class="col-sm-6 col-xs-12" >
            <div class="panel panel-inverse" id="">
			    ...
			    <div class="panel-body " id="indoorPocketWatch_panel_box">
	                 <div class="clearboth form-box " >
...
<script>
    ...
    App.setPageTitle('户内挂表- 工程项目管理系统 ');
    ...
    if(!getProjectInfo()){
    	...
    	$('#suName').val(projJson.suName); // 监理单位
    	$('#corpName').val(projJson.corpName); // 建设单位-燃气公司
    	$('#custName').val(projJson.custName); // 用户单位
   ...
   if($(".iframe-report").length > 0){
    ...
    $.getScript('projectjs/inspection/inspection-common.js?'+Math.random()).done(function() {
		   $.getScript('projectjs/inspection/indoor-pocket-watch.js?'+Math.random()).done(function () {
		   	indoorPocketWatch.init();
		});
 	});
    ...
    var showReport = function(){
        ...
        //cpt路径及参数
        var ur = "indoorPocketWatch.cpt";
        //判断是否为新报验单
        if(isUpdate()){
            ur = "indoorPocketWatchNew.cpt";
        }
        var src = cptPath+"/ReportServer?reportlet=inspection/"+ur;
        if(!pcId){
        	pcId='-1';
        	// src = src + "indoorPocketWatch.cpt";
        }
        //src = src + "indoorPocketWatch1.cpt";
  ...
  //移动端点击上传
    ...
    $("#recordImagesList .uploadBtn").off("click").on("click",function(){
    	var pcId = $('#pcId1').val();
		var projId = $("#projId").val(),projNo=$('#ipwId1').val(),
		stepId=getStepId();
		...
		if(_inApk && $(".attach-images-list").find(".new-image").length){
		    ...
		    //navigator.notification.alert(files);
		     if (!projNo && $("#ipwId1").length && !$("#ipwId1").val()) {
