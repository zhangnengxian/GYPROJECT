						    ...
						    <div class="clearboth form-box">
								...
								<form class="form-horizontal" id="signForm"  enctype="multipart/form-data"  data-parsley-validate="true" action="${actionName }/saveSignFile">							
									...
									<div class="form-group col-md-6 col-sm-12">
										...
										<div>
											<input type="text" class="form-control input-sm datepicker-default field-editable addClear allText construction testLeader"  id="inspectionDate" name="inspectionDate" />
										</div>
									</div>
	                   	...
	                   	<div class="tab-pane fade  btn-top" id="default-tab-3">
						    ...
						    <div class="clearboth form-box">
		                   		...
		                   		<form class="form-horizontal" id="auditForm" data-parsley-validate="true" action="">
		                   			<input type="hidden" id="purgeId" name="purgeId" class="addClear">
									<input type="hidden" id="version1" name="version" class="addClear"/>
		                   			...
		                   			<div class="form-group col-md-6 col-sm-12">
										...
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText construction testLeader" id="pipeSectionNo"   name="pipeSectionNo" data-parsley-maxlength="30"  data-parsley-required="true"/>
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="pileNo">桩号</label>
										<div>
											<input type="text" class="form-control  input-sm field-editable addClear allText construction testLeader" id="pileNo"   name="pileNo" data-parsley-maxlength="30"  />
							              </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="purgeSpec">规格</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText construction testLeader" id="purgeSpec"   name="purgeSpec" data-parsley-maxlength="50"   />
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="purgeLen">长度(M)</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText construction testLeader" id="purgeLen"   name="purgeLen" data-parsley-maxlength="30"  />
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="purgePressure">吹扫压力(MPa)</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText construction testLeader" id="purgePressure"   name="purgePressure" data-parsley-maxlength="30"   />
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="purgeMedium">吹扫介质</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText construction testLeader" id="purgeMedium"   name="purgeMedium" data-parsley-maxlength="50"  d/>
							            </div>
									</div>
									<div class="form-group col-md-6 col-sm-12">
										<label class="control-label" for="purgeRecord">吹扫记录</label>
										<div>
							                <input type="text" class="form-control  input-sm field-editable addClear allText construction testLeader" id="purgeRecord"   name="purgeRecord" data-parsley-maxlength="200" />
							            </div>
									</div>
									
									<div class="form-group col-sm-6 col-xs-12 allSign construction testLeader">
		                   			...
		                   			<div class="form-group col-md-12 col-sm-12 clearboth">
										<label class="control-label" for="purgeRemark">备注</label>
										<div>
											<input type="text" class="form-control input-sm field-editable addClear allSign construction testLeader" id="purgeRemark" rows="2"  name="purgeRemark"  data-parsley-maxlength="200" />
							           </div>
									</div>
...
<script>
    ...
    App.setPageTitle('吹扫记录- 工程项目管理系统 ');
   ...
   if($(".iframe-report").length > 0){
    ...
    $.getScript('projectjs/inspection/inspection-common.js?'+Math.random()).done(function() {
 	   $.getScript('projectjs/inspection/purge-record.js?'+Math.random()).done(function () {
    		purgeRecord.init();
 	   });
	});
  ...
  //图片查看功能
    ...
    var showReport = function(){
       ...
       var pcId = $("#pcIdNew").val();
        ...
        var ur = "purgeRecord.cpt";
		//判断是否为新报验单
        if(isUpdate()){
            ur = "purgeRecordNew.cpt";
        }
        //cpt路径及参数
        var src=cptPath+"/ReportServer?reportlet=inspection/"+ur+"&projName="+projName+"&projNo="+projNo+"&suName="+suName+"&custName="+custName+"&constructionUnit="+constructionUnit;
    ...
    $("#recordImagesList .uploadBtn").off("click").on("click",function(){
    	var pcId = $('#pcId1').val();
		var projId = $("#projId").val(),projNo=$('#purgeId1').val(),
		stepId=getStepId();
		...
		if(_inApk && $(".attach-images-list").find(".new-image").length){
		    ...
		    //navigator.notification.alert(files);
		     if (!projNo && $("#purgeId1").length && !$("#purgeId1").val()) {
