...
<div class="form-box clearboth">
	...
	<input type="hidden" id="aspectRatio" value="1" />
		...
		<div class="form-group col-md-6">
			...
			<div>
				<input class="form-control input-sm field-not-editable"  name="loginAccount" id="loginAccount" data-parsley-required ='true'>
			</div>
		</div>
		<!-- <div class="form-group col-md-6 hidden">
			<label class="control-label" for="password">登录密码</label>
			<div>
				<input class="form-control input-sm field-not-editable" type ='password'  name="password" id="password" data-parsley-required ='true'>
			</div>
		</div> -->
		<div class="form-group col-md-6">
			<label class="control-label" for="idCardNo">身份证号</label>
			<div>
				<input class="form-control input-sm field-not-editable"  name="idCardNo" id="idCardNo" data-parsley-maxlength ='18'>
			</div>
		</div>
		<%-- <div class="form-group col-md-6">
			...
			<div>
				<select id="post" name="post" class="form-control input-sm field-editable">
					<option value=""></option>
					<c:forEach var="enums" items="${posts}">
						<option value="${enums.value }">${enums.message }</option>
					</c:forEach>
				</select>
				<!-- <input class="form-control input-sm field-editable"  name="post" id="post"> -->
			</div>
		</div> --%>
		<div class="form-group col-md-6">
		...
		<div class="form-group col-md-6">
			...
			<div>
				<select id="unitType" name="unitType" class="form-control input-sm field-not-editable">
					<option value=""></option>
		...
		<div class="form-group col-md-6 ">
			<label class="control-label" for="upPhoto">头像</label>
			<div>
		...
		<div class="form-group col-md-12 col-sm-12 clearboth hidden">
		        <label class="control-label" for="">燃气公司</label>
		        <div>
		            <input type="text" class="form-control input-sm field-not-editable"  id="belongCorpName" name="belongCorpName" data-parsley-maxlength="1000" />
		            <a id="corpNamePop" class="asBtn btn btn-default btn-sm m-l-10 aspop" title="选择燃气公司"><i class="fa fa-search"></i></a>
		        </div>
		   </div>
		 <ul class="nav nav-tabs p-t-5 p-l-5 clearboth hidden">
		...
		<div class="tab-content p-l-0 p-r-0 p-t-5 hidden">
			...
			<div class="tab-pane fade  btn-top hidden" id="tab-2" >
