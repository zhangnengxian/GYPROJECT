       	...
       	<div class="panel panel-inverse tabs-mixin" id="">
            ...
            <div class="panel-body">
            	 ...
            	 <input type="hidden" id="caiId" name="caiId"/>
                	<select id="projLtypeIdDes" class="form-control input-sm field-editable width-150" name="projLtypeIdDes" >
						<option value=""></option>
       					<c:forEach var="enums" items="${projLtypeIdDes}">
               	...
               	<div class="mask-html text-center"><div><i class="fa fa-3x fa-spinner"></i><br><p class="text-ellipsis">加载中</p></div></div>
                    <div class="tab-content">
                   	<div class="tab-pane fade active in btn-top" id="default-tab-1">
                       	<table id="accessoryItemTable" class="table table-striped table-bordered nowrap" width="100%">
                            <thead>
                                <tr>
                                	<th></th>
                                    <th>工程类型</th>
...
<script>
    ...
    $.getScript('projectjs/standard/accessory-item.js?v='+Math.random()).done(function () {
        accessoryItem.init();
	});
