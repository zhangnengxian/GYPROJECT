        ...
        <div class="col-sm-6 col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <table id="turnFixedApplyTable" data-attach-table="all" class="table table-striped table-bordered nowrap" width="100%">
                    	<thead>
                            <tr>
                            	<th>工程ID</th>
                                <th>工程编号</th>
...
<script>
    ...
    App.setPageTitle('转固申请 - 工程项目管理系统 ');

    $.getScript('projectjs/settlement/turn-fixed-apply.js').done(function () {
        turnFixedApply.init();
    });
