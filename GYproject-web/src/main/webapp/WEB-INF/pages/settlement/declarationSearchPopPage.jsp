...
<div class="clearboth form-box">
    <form class="form-horizontal" id="declarationSearchPopPage" action="/" method="POST">
        ...
        <div class="form-group col-md-12">
            <label class="control-label" for="cuName">分包公司</label>
            <div>
...
<script>
    ...
    $("#declarationSearchPopPage").styleFit();
