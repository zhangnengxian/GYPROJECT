							...
							<form class="form-horizontal" id="govAuditCostForm" action="govAuditCost/updateGovAUditCostFile" data-parsley-validate="true"  enctype="multipart/form-data" >
								...
								<div class="form-group col-lg-6 col-md-12 col-sm-6 ">
						          ...
						          <div class="form-group col-lg-6 col-md-12 col-sm-6 clearboth">
						              ...
						              <div>
						           		<input type="text" class="form-control input-sm fixed-number field-not-editable text-right" data-parsley-min="0.00"  id="endDeclarationCost" name="endDeclarationCost" value="" />
						            	<a href="javascript:;" class="btn btn-sm btn-default " disabled="disabled">元</a>
						             </div>
						          </div> 
						          <div class="form-group col-lg-6 col-md-12 col-sm-6">
...
<script>
    ...
    //初始化上传文件控件
    $.getScript('projectjs/data/form-multiple-upload.demo3.js?v=1017').done(function() {
    ...
    $.getScript('projectjs/settlement/govAuditCost.js?v='+Math.random()).done(function () {
    	govAuditCost.init();
	});
    ...
    var saveBtnBack = function(){
        ...
        if($("#filePreviews tr").length) {     //有附件 
            ...
            $("#budget_register_panel_box").loadMask("正在保存...", 1, 0.5);
			var response = $.ajax({
				...
				success: function (data) {
					 $("#budget_register_panel_box").hideMask();
					saveBack(data);
				}
			});
		}
