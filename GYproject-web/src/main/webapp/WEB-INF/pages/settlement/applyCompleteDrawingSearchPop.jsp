...
<div class="clearboth form-box">
    <form class="form-horizontal" id="applyCompleteDrawingSearchPop" action="/" method="POST">
        ...
        <div class="form-group col-md-12">
            <label class="control-label" for="auditState">审核状态</label>
            <div>
...
<script>
    ...
    $("#applyCompleteDrawingSearchPop").styleFit();
