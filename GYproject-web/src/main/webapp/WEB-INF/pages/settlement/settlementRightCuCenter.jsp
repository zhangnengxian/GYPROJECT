...
<div class="infodetails">
    ...
    <div class="clearboth form-box">
    	...
    	<form class="form-horizontal" id="settlementJonintlySignRightForm" action="" data-parsley-validate="true" >
    		...
    		<div class="form-group col-md-6 col-sm-12 clearboth allSign assoDirector">
				<label class="control-label signature-tool sign-require" for="viceMinisterSign">主任</label>
				<div>
					...
					<input type="hidden" id="viceMinisterSign_postType" name="viceMinisterSign_postType" value="${recorderPost}">
    		...
    		<div class="form-group col-md-6 col-sm-12 public allSign suJgj ">
				<label class="control-label  public" for="sujgjSign">审核人</label>
				<div>
    		...
    		<div class="form-group col-md-6 col-sm-12 public allSign suCse ">
				<label class="control-label  public" for="sucseSign">负责人</label>
				<div>
