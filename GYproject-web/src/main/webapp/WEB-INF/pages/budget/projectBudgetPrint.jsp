    ...
    <div class="row">
        ...
        <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">建设工程预算书列表</h4>
                </div>
            ...
            <div class="panel panel-inverse">
			    ...
			    <div class="panel-body">
			    	<div class="iframe-report-box">
	                 	<iframe id="mainFrm" class="iframe-report" style="width: 1100px; height: 795px;border:0; overflow-y:auto;" scrolling="no"></iframe>
	                </div>
			    </div>
			</div>
        </div>
...
<script>
	...
	App.setPageTitle('建设工程预算书打印 - 工程管理系统');
	...
	$.getScript('projectjs/budget/project-budget-print.js?v='+Math.random()).done(function () {
		budgetPrint.init();
	});
    ...
    var showReport = function(){
		...
		src = cptPath+"/ReportServer?reportlet=budget/projectBudgetPrint.cpt";
