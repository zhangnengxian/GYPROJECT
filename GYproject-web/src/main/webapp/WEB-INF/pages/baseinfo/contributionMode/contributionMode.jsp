               	...
               	<div class="mask-html text-center"><div><i class="fa fa-3x fa-spinner"></i><br><p class="text-ellipsis">加载中</p></div></div>
                    <div class="tab-content">
                   	<div class="tab-pane fade active in btn-top" id="default-tab-1">
                       	<table id="contributionModeTable" class="table table-striped table-bordered nowrap" width="100%">
                            <thead>
                                <tr>
                                	<th></th>
                                    <th>出资方式</th>
...
<script>
    ...
    App.setPageTitle('出资方式 - 工程管理系统');
    
    $.getScript('projectjs/contributionMode/contribution-mode.js?v='+Math.random()).done(function () {
    	contributionMode.init();
	});
