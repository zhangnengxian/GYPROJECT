        ...
        <div class="col-sm-6 col-xs-12">
       	<div class="panel panel-inverse tabs-mixin" id="">
			<div class="panel-heading">
                ...
                <h4 class="panel-title">定位设置列表</h4>
               
			</div>
            <div class="panel-body">
            	 <div id="caiIdDes" class=" pull-left">
            	 <input type="hidden" id="ssId" name="ssId"/>
                	<select id="deptName" class="form-control input-sm field-editable width-150" name="deptType" >
						<option value=""></option>
               	...
               	<div class="mask-html text-center"><div><i class="fa fa-3x fa-spinner"></i><br><p class="text-ellipsis">加载中</p></div></div>
                    <div class="tab-content">
                   	<div class="tab-pane fade active in btn-top" id="default-tab-1">
                       	<table id="locationSetUpTable" class="table table-striped table-bordered nowrap" width="100%">
                            <thead>
                                <tr>
                                	<th></th>
                                    <th>部门</th>
...
<script>
    ...
    App.setPageTitle('定位设置 - 工程管理系统');
    $('#planAuditForm').styleFit();
    
    $.getScript('projectjs/baseinfo/location-set-up.js').done(function () {
        scoreStandard.init();
	});
