 ...
 */
@Controller
@RequestMapping(value="/engineeringVisaAudit")
public class EngineeringAuditController {
	...
	public ModelAndView main(){
		...
		modelView.setViewName("constructmanage/engineeringAudit");
		return modelView;
	}
	...
	public Map<String,Object> queryVisaAudit(HttpServletRequest request,EngineeringVisaQueryReq engineeringVisaQueryReq){
		try {
			...
			Map<String, Object> map = engineeringVisaService.queryVisaAudit(engineeringVisaQueryReq);
			return map;
		} catch (Exception e) {
	...
	*/
	...
	public ModelAndView audit(HttpServletRequest request){
		...
		modelView.setViewName("constructmanage/engineeringVisaAuditPage");
		return modelView;
	}
	...
	public ResultMessage auditSave(@RequestBody(required = true) ManageRecord manageRecord){
		...
		try {
			String res = manageRecordService.engineeringAuditSave(manageRecord,"","",StepOutWorkflowEnum.ENGINEERING_AUDIT.getValue());
