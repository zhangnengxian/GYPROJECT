 ...
 */
@Controller
@RequestMapping(value="/constructionPlanStatistics")
public class ConstructionPlanStatisticsController {
	...
	public ModelAndView main() throws ParseException {
		...
		modelView.setViewName("project/statisticquery/constructionPlanStatistics");
		return modelView;
	}
}
