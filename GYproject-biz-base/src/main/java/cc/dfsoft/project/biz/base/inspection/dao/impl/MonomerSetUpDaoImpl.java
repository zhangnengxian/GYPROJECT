...
@Repository
public class MonomerSetUpDaoImpl extends NewBaseDAO<MonomerSetUp, String> implements  MonomerSetUpDao {
	...
	public Map<String, Object> queryAltimSurvey(AltimetricSurveyReq altimetricSurveyReq) {
		Criteria c = super.getCriteria();			
		 ...
		 // 根据条件获取查询信息
		 List<MonomerSetUp> list = this.findBySortCriteria(c, altimetricSurveyReq);
	...
	public void deleteByPcId(String pcId) {
		StringBuffer hql = new StringBuffer("delete from MonomerSetUp where pcId='").append(pcId).append("'");
