 ...
 */
@Controller
@RequestMapping(value="/pipeWeldRecord")
public class PipeWeldRecordController {
	
	/** 日志实例 */
	private static Logger logger = LoggerFactory.getLogger(PipeWeldRecordController.class);
	...
	public ModelAndView main(){
		...
		modelView.setViewName("inspection/pipeWeldRecord");
		return modelView;
	}
