...
public class Exception  extends nc.bd.itf.receiptBill.service.Throwable  implements java.io.Serializable {
    public Exception() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.uap.nc/lang", "Exception"));
    }
